                            ...
                            <div class="col-lg-12">
                                <div class="banner-spot clearfix">
                                    <div class="banner-img">
                                        <img src="<?= get_template_directory_uri() ?>/assets/upload/banner_01.jpg"
                                            alt="" class="img-fluid">
                                    </div><!-- end banner-img -->
                                </div><!-- end banner -->
                            </div><!-- end col -->
                            ...
                            <div class="row">
                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="<?= get_template_directory_uri() ?>/assets/upload/menu_06.jpg"
                                                    alt="" class="img-fluid">
                                ...
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="single.html" title="">
                                                <img src="<?= get_template_directory_uri() ?>/assets/upload/menu_07.jpg"
                                                    alt="" class="img-fluid">
                                                <div class="hovereffect">
                                                    <span class=""></span>
                                                </div><!-- end hover -->
                                    ...
                                    <div class="comments-list">
                                        <div class="media">
                                            <a class="media-left" href="#">
                                                <img src="<?= get_template_directory_uri() ?>/assets/upload/author.jpg"
                                        ...
                                        <div class="media">
                                            <a class="media-left" href="#">
                                                <img src="<?= get_template_directory_uri() ?>/assets/upload/author_01.jpg"
                                                    alt="" class="rounded-circle">
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <div class="media last-child">
                                            <a class="media-left" href="#">
                                                <img src="<?= get_template_directory_uri() ?>/assets/upload/author_02.jpg"
                                                    alt="" class="rounded-circle">
                                            </a>
                                            <div class="media-body">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="instagram-wrapper clearfix">
                                <a class="" href="#"><img
                                        src="<?= get_template_directory_uri() ?>/assets/upload/insta_01.jpeg" alt=""
                                        class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_02.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_03.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_04.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_05.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_06.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_07.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_08.jpeg"
                                        alt="" class="img-fluid"></a>
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/upload/insta_09.jpeg"
                                        alt="" class="img-fluid"></a>
