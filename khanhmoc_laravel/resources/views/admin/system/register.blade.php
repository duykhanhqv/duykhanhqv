      ...
      <div class="col-lg-4 mx-auto">
        ...
        <div class="auto-form-wrapper">
          <form action="{{ route('s.registerpost')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="@lang('Name')" name="name" value="{{old('name')}}">
                <div class="input-group-append">
                  <span class="input-group-text">
            ...
            <div class="form-group">
              <div class="input-group">
                <input type="password" class="form-control" name="password_confirm" placeholder="@lang('Confirm Password')"
            ...
            <div class="text-block text-center my-3">
              ...
              <a href="{{route('s.login')}}" class="text-black text-small">@lang('Login')</a>
            </div>
          </form>
        </div>
      </div>
