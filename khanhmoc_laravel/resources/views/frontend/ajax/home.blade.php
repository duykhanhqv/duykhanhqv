        ...
        <div class="row text-center">
            <div class="col-sm-4">
                <div class="service-text">
                    ...
                    <p>@lang('You just need to stay at home and choose, we will <br /> have the staff deliver to your
                        place')</p>
                </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div class="service-text">
                    ...
                    <p>@lang('Within 30 days, if there is any defect in the product,<br /> you will be able to return it
                        for free')</p>
                </div>
            </div>
        </div>
