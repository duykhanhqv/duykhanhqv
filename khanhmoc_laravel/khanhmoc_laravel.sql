...
--
-- Cơ sở dữ liệu: `khanhmoc_laravel`
--
...
--
-- Cấu trúc bảng cho bảng `fs_admin`
--
...
--
-- Đang đổ dữ liệu cho bảng `fs_admin`
--

INSERT INTO `fs_admin` (`id`, `password`, `email`, `name`, `created_at`, `updated_at`) VALUES
...
--
-- Cấu trúc bảng cho bảng `fs_answer`
--

DROP TABLE IF EXISTS `fs_answer`;
...
--
-- Đang đổ dữ liệu cho bảng `fs_answer`
--
...
--
-- Cấu trúc bảng cho bảng `fs_category`
--
...
--
-- Đang đổ dữ liệu cho bảng `fs_category`
--

INSERT INTO `fs_category` (`id`, `department_id`, `name`, `order`, `active`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'Điện thoại di động', 1, 1, 1, NULL, NULL),
(3, 1, 'Máy cũ', 3, 1, 1, NULL, NULL),
(5, 2, 'Máy tính bảng', 1, 1, 1, NULL, NULL),
(7, 2, 'Laptop', 3, 1, 1, NULL, NULL),
(9, 3, 'Tai nghe Bluetooth', 1, 1, 1, NULL, NULL),
(10, 3, 'Bao da', 1, 1, 1, NULL, NULL),
(11, 3, 'Tai nghe dây', 1, 1, 1, NULL, NULL),
(12, 3, 'Sạc', 1, 1, 1, NULL, NULL),
(13, 3, 'Thẻ nhớ', 1, 1, 1, NULL, NULL),
(14, 3, 'Loa nghe nhạc', 1, 1, 1, NULL, NULL),
(15, 3, 'Thiết bị kết nối máy tính', 1, 1, 1, NULL, NULL),
(16, 3, 'Dán bảo vệ màn hình & Trang trí', 1, 1, 1, NULL, NULL),
(17, 3, 'Pin ', 1, 1, 1, NULL, NULL),
(18, 4, 'Thiết bị mạng', 1, 1, 1, NULL, NULL),
(19, 4, 'Adapter sạc', 1, 1, 1, NULL, NULL),
(20, 4, 'Loa và tai nghe', 1, 1, 1, NULL, NULL),
(21, 4, 'Chuột/ Bàn phím', 1, 1, 1, NULL, NULL),
(22, 4, 'Thiết bị lưu trữ ', 1, 1, 1, NULL, NULL),
(23, 5, 'Máy ảnh', 1, 1, 1, NULL, NULL),
(24, 5, 'Máy MP3', 1, 1, 1, NULL, NULL),
(25, 5, 'MP4/MP5', 1, 1, 1, NULL, NULL),
(26, 5, 'HD Player', 1, 1, 1, NULL, NULL),
(27, 5, 'Từ điển điện tử', 1, 1, 1, NULL, NULL),
(28, 5, 'Máy quay phim', 1, 1, 1, NULL, NULL),
(29, 5, 'Phụ kiện KTS', 1, 1, 1, NULL, NULL),
(30, 5, 'Máy ghi âm', 1, 1, 1, NULL, NULL),
(53, 9, 'Dải đệm Massage', 1, 1, 1, NULL, NULL),
(54, 9, 'Máy đo huyết áp', 1, 1, 1, NULL, NULL),
(55, 9, 'Massage chân', 1, 1, 1, NULL, NULL),
(56, 9, 'Massage cầm tay', 1, 1, 1, NULL, NULL),
(57, 9, 'Massage bụng', 1, 1, 1, NULL, NULL),
(58, 9, 'Ghế massage', 1, 1, 1, NULL, NULL),
(59, 9, 'Nhiệt kế', 1, 1, 1, NULL, NULL),
(60, 10, 'Hút khói - Khử mùi', 1, 1, 1, NULL, NULL),
(61, 10, 'Máy may / Thêu', 1, 1, 1, NULL, NULL),
...
(73, 1, 'Xay / Xay ép đa năng', 1, 0, 1, NULL, '2021-07-02'),
(74, 12, 'Máy pha cà phê', 1, 0, 1, NULL, '2021-06-30'),
(75, 2, 'Máy đánh trứng', 1, 0, 0, NULL, '2021-06-30'),
(79, 1, 'Phụ kiện', 4, 0, 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `fs_department`
--

DROP TABLE IF EXISTS `fs_department`;
...
--
-- Đang đổ dữ liệu cho bảng `fs_department`
--

INSERT INTO `fs_department` (`id`, `name`, `order`, `active`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Điện Thoại', 1, 1, 1, NULL, NULL),
(2, 'Máy Tính', 2, 1, 1, NULL, NULL),
(3, 'Phụ Kiện Điện Thoại', 5, 0, 1, NULL, NULL),
(4, 'Phụ Kiện Laptop', 5, 0, 1, NULL, NULL),
(5, 'Kỹ Thuật Số', 5, 0, 1, NULL, NULL),
(9, 'Chăm sóc sức khoẻ', 4, 0, 1, NULL, NULL),
(10, 'Điện gia đình', 5, 0, 1, NULL, NULL),
(12, 'Sinh tố, Xay, Ép, Pha', 5, 0, 1, NULL, NULL),
(24, 'Alex Chao', NULL, 0, 0, '2021-06-30', '2021-06-30'),
(25, 'Alex', NULL, 0, 0, '2021-06-30', '2021-06-30'),
(26, 'Moc moc', NULL, 0, 0, '2021-07-01', '2021-07-01');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `fs_division_role`
--

DROP TABLE IF EXISTS `fs_division_role`;
CREATE TABLE IF NOT EXISTS `fs_division_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `fs_online`
--

DROP TABLE IF EXISTS `fs_online`;
CREATE TABLE IF NOT EXISTS `fs_online` (
...
--
-- Đang đổ dữ liệu cho bảng `fs_online`
--
...
CREATE TABLE IF NOT EXISTS `fs_order` (
  ...
  `status` tinyint(4) DEFAULT NULL COMMENT '0:Mới đặt, 1:Đã xác nhận,2:Đang giao,3:Hoàn tất,4: Huỷ',
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=59 DEFAULT CHARSET=utf8;

--
-- Đang đổ dữ liệu cho bảng `fs_order`
--

INSERT INTO `fs_order` (`id`, `user_id`, `created_at`, `name`, `address`, `ship_at`, `email`, `mobile`, `remark`, `status`, `updated_at`) VALUES
(57, 100, '2021-07-01 14:38:49', 'Quốc Đạt', '54 Phan Xích Long', NULL, 'duykhanhqv@gmail.com', '0352902397', NULL, -1, '2021-07-02 05:56:51'),
(9, 100, '2014-01-04 20:10:05', 'Lê Văn Test', '49 Hoàng Văn Thụ, Phường 2, Quận Phú Nhuận, TP. Hồ Chí Minh', '2013-03-07 00:00:00', 'admin@gmail.com', '0901234567', '', 1, '2021-07-02 05:32:46'),
(10, 100, '2017-07-28 06:18:13', 'Lê Văn Test', '49 Hoàng Văn Thụ, Phường 2, Quận Phú Nhuận, TP. Hồ Chí Minh', '2017-07-30 00:00:00', 'admin@gmail.com', '0901234567', '', 2, NULL),
(11, 100, '2017-07-28 06:19:21', 'Lê Văn Test', '49 Hoàng Văn Thụ, Phường 2, Quận Phú Nhuận, TP. Hồ Chí Minh', '2017-07-30 00:00:00', 'admin@gmail.com', '0901234567', '', 3, '2021-07-02 05:39:16'),
(12, 100, '2017-07-28 06:20:56', 'Lê Văn Test', '49 Hoàng Văn Thụ, Phường 2, Quận Phú Nhuận, TP. Hồ Chí Minh', '2017-07-30 00:00:00', 'admin@gmail.com', '0901234567', '', 4, '2021-07-02 05:52:29'),
(58, 100, '2021-07-01 14:53:38', 'Khánh Mốc', '90 Phạm Văn Đồng', NULL, 'duykhanhqv@gmail.com', '0352902397', NULL, -1, '2021-07-02 05:58:05'),
(56, 100, '2021-07-01 14:28:22', 'Quốc Đạt', '88 Trường Chinh', NULL, 'duykhanhqv@gmail.com', '0352902397', NULL, -1, '2021-07-02 05:58:15'),
(55, 100, '2021-07-01 13:58:34', 'Van Hoai', '89 Ha Van Lao', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, -1, '2021-07-02 05:58:29'),
(53, 100, '2021-06-19 08:19:19', 'Khánh Mốc', '55 Le Lai', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, -1, '2021-07-02 05:59:20'),
(52, 100, '2021-06-19 08:06:35', 'Khánh Mốc', '55 Le Lai', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, 4, '2021-07-02 05:59:13'),
(48, 100, '2021-06-19 08:01:07', 'Khánh Mốc', '388 Nguyeenx Thij Lang', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, 0, '2021-06-19 08:01:07'),
(51, 100, '2021-06-19 08:05:40', 'Van Hoai', '388 Le Loi', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, -1, '2021-07-02 06:01:23'),
(50, 100, '2021-06-19 08:04:28', 'Van Hoai', '388 Le Loi', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, -1, '2021-07-02 06:01:31'),
(49, 100, '2021-06-19 08:01:57', 'Van Hoai', '388 Le Loi', NULL, 'mocmoc@gmaill.com', '0352902397', NULL, 0, '2021-06-19 08:01:57');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `fs_order_detail`
--

DROP TABLE IF EXISTS `fs_order_detail`;
CREATE TABLE IF NOT EXISTS `fs_order_detail` (
...
--
-- Đang đổ dữ liệu cho bảng `fs_order_detail`
--

INSERT INTO `fs_order_detail` (`order_id`, `product_id`, `qty`, `price`, `created_at`) VALUES
(9, 2, 2, '9899000.0000', '0000-00-00 00:00:00'),
(9, 1, 1, '11449000.0000', '0000-00-00 00:00:00'),
(10, 1, 1, '11449000.0000', '0000-00-00 00:00:00'),
(10, 2, 4, '9899000.0000', '0000-00-00 00:00:00'),
(11, 1, 1, '11449000.0000', '0000-00-00 00:00:00'),
(11, 2, 4, '9899000.0000', '0000-00-00 00:00:00'),
(12, 1, 1, '11449000.0000', '0000-00-00 00:00:00'),
(12, 2, 3, '9899000.0000', '0000-00-00 00:00:00'),
(12, 219, 2, '13699000.0000', '0000-00-00 00:00:00'),
(45, 2, 1, '9899000.0000', '2021-06-19 07:56:17'),
(50, 2, 1, '9899000.0000', '2021-06-19 08:04:28'),
(51, 2, 1, '9899000.0000', '2021-06-19 08:05:40'),
(52, 2, 1, '9899000.0000', '2021-06-19 08:06:35'),
(52, 470, 1, '6400000.0000', '2021-06-19 08:06:35'),
(53, 2, 1, '9899000.0000', '2021-06-19 08:19:19'),
(53, 470, 1, '6400000.0000', '2021-06-19 08:19:19'),
(54, 470, 2, '6400000.0000', '2021-07-01 13:53:50'),
(54, 2, 1, '9899000.0000', '2021-07-01 13:53:50'),
(55, 2, 1, '9899000.0000', '2021-07-01 13:58:34'),
(56, 354, 1, '16899000.0000', '2021-07-01 14:28:22'),
(57, 4, 1, '9799000.0000', '2021-07-01 14:38:49'),
(58, 7, 1, '8679000.0000', '2021-07-01 14:53:38');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `fs_product`
--
...
(40, 1, 'Nokia X2-01', '2149000.0000', '<p>- Thiết kế mạnh mẽ với b&agrave;n ph&iacute;m Qwerty<br /> - M&aacute;y ảnh VGA, hỗ trợ quay phim<br /> - M&aacute;y nghe nhạc MP3/WMA/WAV/eAAC+<br /> - Đ&agrave;i FM t&iacute;ch hợp<br /> - Kết nối Bluetooth<br /> - Dung lượng pin cao 1020 mAh</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(44, 1, 'Nokia C1-01', '1329000.0000', '<p>- Thiết kế dạng thanh thời trang<br /> - M&aacute;y ảnh VGA<br /> - Hỗ trợ thẻ nhớ ngo&agrave;i microSD<br /> - M&aacute;y nghe nhạc MP3/WAV/AAC+<br /> - Đ&agrave;i FM t&iacute;ch hợp, ghi &acirc;m FM<br /> - Jack tai nghe 3.5mm</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(55, 1, 'Motorola CD920', '0.0000', '<p>- Ghi &acirc;m đến 3 ph&uacute;t.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(56, 1, 'Motorola CD930    ', '0.0000', '<p>- Ghi &acirc;m đến 3 ph&uacute;t.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(57, 1, 'Motorola MB300 BACKFLIP   ', '5899000.0000', '<ul class=\"item_list\" style=\"padding-left: 15px; margin: 0px;\">\r\n<li>Kiểu d&aacute;ng độc đ&aacute;o với b&agrave;n ph&iacute;m lật</li>\r\n<li>M&aacute;y ảnh 5 MP, hỗ trợ LED Flash</li>\r\n<li>Hệ điều h&agrave;nh Android 1.5</li>\r\n<li>Kết nối internet với Wifi v&agrave; mạng 3G</li>\r\n<li>Định vị to&agrave;n cầu GPS</li>\r\n<li>Xem file văn bản, mạng x&atilde; hội Facebook, MySpace, Twitter apps </li>\r\n</ul>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(58, 1, 'Motorola D520 ', '0.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(59, 1, 'Motorola EX300', '2689000.0000', '<ul class=\"item_list\" style=\"padding-left: 15px; margin: 0px;\">\r\n<li>M&aacute;y ảnh 3.0 MP, hỗ trợ quay phim</li>\r\n<li>Mạng 3G, chức năng định vị GPS</li>\r\n<li>Nghe nhạc, xem phim nhiều định dạng</li>\r\n<li>Đ&agrave;i Fm t&iacute;ch hợp </li>\r\n</ul>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(60, 1, 'Motorola E360', '0.0000', '<p>- WAP 1.2.1.<br />- Từ điển T9.<br />- M&aacute;y t&iacute;nh.<br />- Chuyển đổi tiền tệ.<br />- Chức năng tổ chức.<br />- Ghi &acirc;m.<br />- Quya số giọng n&oacute;i.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(62, 1, 'Motorola E365  ', '0.0000', '<p>- WAP 2.0.<br />- Từ điển T9.<br />- M&aacute;y t&iacute;nh.<br />- Chuyển đổi tiền tệ.<br />- Chức năng tổ chức.<br />- Ghi &acirc;m.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(64, 1, 'Motorola E380 ', '0.0000', '<p>- Java.<br />- WAP 2.0.<br />- Từ điển T9.<br />- M&aacute;y t&iacute;nh.<br />- Chuyển đổi tiền tệ.<br />- Chức năng tổ chức.<br />- Ghi &acirc;m.<br />- Cổng USB.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(66, 1, 'Motorola E390', '0.0000', '<p>- Bluetooth.<br />- WAP 2.0.<br />- Tr&igrave;nh duyệt xHTML.<br />- Từ điển T9.<br />- M&aacute;y t&iacute;nh.<br />- Chuyển đổi tiền tệ.<br />- Chức năng tổ chức.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(68, 1, 'Motorola M3188 ', '0.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(70, 1, 'Motorola M3288 ', '0.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(71, 1, 'Motorola RAZR V3i D&G Gold ', '0.0000', '<p><strong><span style=\"color: #ff0000;\">MOTOROLA RAZR V3i - Moto thời trang<br /></span></strong>- Thiết kế mỏng với vỏ bằng nh&ocirc;m chống trầy xước<br />- Nghe nhạc MP3<br />- Camera 1.3MP<br />- Kết nối bluetooth</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(72, 1, 'Motorola M3588', '0.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(73, 1, 'Motorola C350', '0.0000', '<p>- WAP 1.2.1.<br />- Từ điển T9.<br />- M&aacute;y t&iacute;nh.<br />- Chuyển đổi tiền tệ.<br />- Chức năng tổ chức.<br />- Quya số giọng n&oacute;i</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(74, 1, 'Motorola A6188', '0.0000', '<p>- 2 SIM card.<br />- WAP 1.2.<br />- M&aacute;y t&iacute;nh.<br />- Ghi &acirc;m đến 3 ph&uacute;t.<br />- TrueSync.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(75, 1, 'Motorola C330  ', '0.0000', '<p>- WAP 1.2.1.<br />- Từ điển T9.<br />- Quay số giọng n&oacute;i.<br />- M&aacute;y t&iacute;nh.<br />- Chuyển đổi tiền tệ.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(76, 1, 'Motorola A760', '0.0000', '<p>- Hệ điều h&agrave;nh Linux.<br />- Tốc độ xử l&yacute; 206 Mhz.<br />- Java.<br />- Bluetooth.<br />- Nghe nhạc MP3.<br />- Chức năng quản l&yacute; th&ocirc;ng tin c&aacute; nh&acirc;n.<br />- WAP.<br />- Tr&igrave;nh duyệt WEB.<br />- Cổng USB.<br />- RS 232.<br />- Loa speaker.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(95, 1, 'LG LG 600', '0.0000', '<p>- WAP.<br />- T9.<br />- Scheduler.<br />- M&aacute;y t&iacute;nh.<br />- Lịch.<br />- Đồng hồ thế giới.<br />- Quay số giọng n&oacute;i.<br />- Ghi &acirc;m.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(100, 1, 'LG LG 510w ', '0.0000', '<p>- WAP 1.2.1.<br />- T9.<br />- Scheduler.<br />- M&aacute;y t&iacute;nh.<br />- Lịch.<br />- Đồng hồ thế giới.<br />- Quay số giọng n&oacute;i.<br />- Ghi &acirc;m.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(101, 1, 'LG LG 500', '0.0000', '<p>- WAP.<br />- T9.<br />- Scheduler.<br />- M&aacute;y t&iacute;nh.<br />- Lịch.<br />- Đồng hồ thế giới.<br />- Quay số giọng n&oacute;i.<br />- Ghi &acirc;m.<br />- Loa speaker.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(103, 1, 'LG LG 200   ', '0.0000', '<p>- M&aacute;y t&iacute;nh.<br />- Lịch.<br />- Đồng hồ thế giới.<br />- Quay số giọng n&oacute;i.</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(110, 1, 'K Touch Q160   ', '0.0000', '<p>- Thiết kế thời trang c&aacute; t&iacute;nh với m&agrave;n h&igrave;nh xoay tr&ograve;n<br />- Chức năng xem tivi Analog<br />- Camera 2.0 MP<br />- M&aacute;y nghe nhạc, xem phim MP3, MP4<br />- Đ&agrave;i FM t&iacute;ch hợp<br />- Kết nối Bluetooth, USB, GPRS</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
INSERT INTO `fs_product` (`id`, `category_id`, `name`, `price`, `desc`, `detail`, `created_at`, `updated_at`, `qty`, `note`, `sold`, `view`, `active`, `status`, `user_id`) VALUES
(117, 1, 'K Touch V908   ', '0.0000', '<p>- Thiết kế thời trang với m&agrave;n h&igrave;nh cảm ứng rộng<br />- Xem Tivi Analog<br />- Camera 1.3 MP, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc MP3, MP4<br />- Đ&agrave;i FM<br />- Kết nối Bluetooth, USB</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(124, 1, 'K Touch E68   ', '0.0000', '<p>- Điện thoại PDA sử dụng c&ocirc;ng nghệ mạng CDMA<br />- Camera 2.0MP<br />- Hệ điều h&agrave;nh Window Mobile<br />- CPU: Qualcomm, 512<br />- Kết nối Bluetooth, USB, GPRS<br />- Ứng dụng văn ph&ograve;ng</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(178, 1, 'Cayon V850 ', '1189000.0000', '<p>- Thiết kế dạng thanh sang trọng<br />- Camera 2 MP, quay phim<br />- M&aacute;y nghe nhạc MP3<br />- Đ&agrave;i FM, Bluetooth<br />- Chức năng in ảnh trực tiếp</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(182, 1, 'Cayon E530   ', '0.0000', '<p>- Thiết kế thời trang, m&agrave;u sắc sang trọng<br />- Camera 2.0 MP, hỗ trợ quay phim<br />- Hỗ trợ 2 sim, 2 s&oacute;ng online<br />- Thẻ nhớ ngo&agrave;i, m&aacute;y nghe nhạc MP3<br />- Chức năng bluetooth</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(206, 1, 'Sony Ericsson P800  ', '0.0000', '<p>- Java, WAP 2.0.<br />- Tr&igrave;nh duyệt HTML, iMode. <br />- Ghi &acirc;m. <br />- Album h&igrave;nh ảnh</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(235, 1, 'HTC Google Nexus One', '0.0000', '<p>- M&agrave;n h&igrave;nh cảm ứng rộng 3.7 inches<br />- M&aacute;y ảnh 5 MP, hỗ trợ quay phim<br />- 512MB RAM, 512MB ROM&lt;br&gt;<br />- CPU: Qualcomm Snapdragon QSD8250, 1 GHz processor<br />- Kết nối Internet với Wifi tốc độ cao<br />- Chức năng định vị GPS</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(260, 1, 'Mobell M190', '0.0000', '<p>- Thiết kế nhỏ gọn thời trang<br />- Hỗ trợ thẻ ngo&agrave;i l&ecirc;n đến 1Gb<br />- M&aacute;y nghe nhạc MP3<br />- Chức năng ghi &acirc;m<br />- Kết nối USB</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(264, 1, 'Lenovo i350', '1990000.0000', '<p>- Thiết kế thanh mảnh thời trang<br /> - Hỗ trợ 2 Sim 2 S&oacute;ng online<br /> - M&aacute;y ảnh 2.0 MP, hỗ trợ quay phim<br /> - Đ&agrave;i FM t&iacute;ch hợp, jack tai nghe 3.5<br /> - Kết nối Bluetooth, USB, GPRS</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(280, 1, 'Lenovo A910 ', '0.0000', '<p>- Thiết kế mạnh mẽ với m&agrave;n h&igrave;nh cảm ứng rộng 2.8 inches<br />- M&aacute;y ảnh 2.0 MP, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc MP3, xem phim MP4, 3GP<br />- Đ&agrave;i FM t&iacute;ch hợp<br />- Chức năng định vị GPS<br />- Kết nối Bluetooth, USB</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(322, 1, 'F-Mobile B360', '0.0000', '<p>- Thiết kết thời trang giống Samsung L700<br />- Hỗ trợ 2 Sim 2 S&oacute;ng online<br />- M&aacute;y ảnh VGA, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc MP3<br />- Đ&agrave;i FM t&iacute;ch hợp, Bluetooth</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(330, 1, 'Acer Liquid Metal', '0.0000', '<p>- Hệ điều h&agrave;nh Android OS, v2.2<br /> - M&aacute;y ảnh 5.0 MP, hỗ trợ quay phim<br /> - Mạng 3G với tốc độ HSDPA, 14.4 Mbps; HSUPA, 2 Mbps<br /> - Chức năng xem file văn bản<br /> - Wi-Fi 802.11 b/g/n, UPnP</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100);
INSERT INTO `fs_product` (`id`, `category_id`, `name`, `price`, `desc`, `detail`, `created_at`, `updated_at`, `qty`, `note`, `sold`, `view`, `active`, `status`, `user_id`) VALUES
...
(336, 1, 'Philips Xenium X600 ', '0.0000', '<p>- Thiết kế nắp gập thời trang<br />- M&aacute;y ảnh 2.0 MP, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc MP3/WAV/AAC/MP4<br />- Đ&agrave;i FM t&iacute;ch hợp<br />- Kết nối Bluetooth, USB, GPRS</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(343, 1, 'Dell Aero', '0.0000', '<p>- M&agrave;n h&igrave;nh cảm ứng rộng 3.5 inches<br />- M&aacute;y ảnh 3.15 MP, lấy n&eacute;t tự động<br />- Mạng 3G với HSDPA 3.6 Mbps<br />- Kết nối Wifi, GPS, GPRS<br />- Xem file văn bản, chỉnh sửa h&igrave;nh ảnh</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(346, 1, 'Dell Mini 3i', '0.0000', '<p>- M&agrave;n h&igrave;nh cực rộng 3.5 inches<br />- M&aacute;y ảnh 3.15 MP, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc, xem phim nhiều định dạng<br />- Chức năng định vị to&agrave;n cầu GPS<br />- Kết nối Bluetooth, USB</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(347, 1, 'Dell Venue Pro', '0.0000', '<p>- Hệ điều h&agrave;nh Microsoft Windows Phone 7<br /> - CPU: Qualcomm Snapdragon QSD8250, 1 GHz processor<br /> - M&aacute;y ảnh 5.0 MP, lấy n&eacute;t tự động<br /> - Mạng 3G với HSDPA, 7.2 Mbps; HSUPA, 5.76 Mbps<br /> - Hỗ trợ Full flash/silverlight</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(349, 1, 'Dell XCD35', '0.0000', '<p>- Hệ điều h&agrave;nh Android 2.1<br /> - M&aacute;y ảnh 3.2 MP, hỗ trợ quay phim<br /> - M&aacute;y nghe nhạc xem phim MP4/H.264/H.263, MP3/WAV/eAAC+<br /> - Mạng 3G, chức năng định vị GPS<br /> - Xem file văn bản</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(350, 1, 'Dell Smoke', '0.0000', '<p>- Hệ điều h&agrave;nh Android Froyo<br />- M&aacute;y ảnh 5.0 MP, hỗ trợ lấy n&eacute;t tự động<br />-  Mạng 3G với HSDPA 14.4 Mbps; HSUPA 5.76 Mbps<br />- Bluetooth 2.1 v&agrave; Wifi  802.11<br />- Google Search, Maps, Gmail<br />- C&ocirc;ng  nghệ lọc tiếng ồn</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(352, 1, 'eTouch MK67', '0.0000', '<p>- Điện thoại thời trang sang trọng<br />- Camra 2.0 MP, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc <span class=\"specDetails\">MP3 / WAV, xem phim MP4, 3GP<br />- Đ&agrave;i FM<br />- Kết nối Bluetooth, USB, GPRS</span></p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(353, 1, 'eTouch MD82', '0.0000', '<p>- Thiết kế thời trang<br />- Hỗ trợ 2 Sim 2 S&oacute;ng online<br />- M&aacute;y ảnh VGA, hỗ trợ quay phim<br />- M&aacute;y nghe nhạc, xem phim MP3, MP4<br />- Đ&agrave;i FM<br />- Kết nối Bluetooth, USB, GPRS</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(354, 7, 'Acer Aspire 4820TG 452G50 (219)  ', '16899000.0000', '<p><span class=\"star0\">&nbsp;</span> - CPU: Intel Core i5 450M, 2.40 GHz<br /> - Bộ nhớ: DDR3, 2 GB. Đĩa cứng: 500 GB<br /> - M&agrave;n h&igrave;nh: 14 inch HD (1366 x 768 pixels)<br /> - Đồ họa: ATI Mobility Radeon HD 5470<br /> - Đĩa quang: DVD Super Multi Double Layer<br /> - Hệ điều h&agrave;nh: Windows 7 Home Premium. Trọng lượng: 2,1 kg</p>', NULL, '0000-00-00', NULL, 99, NULL, 0, 5, 1, 1, 100),
(355, 7, 'Acer Aspire 4738G ', '16299000.0000', '<p>- CPU: Intel Core i3 350M, 2.26 GHz, L3 Cache,3 MB<br /> - Bo mạch: Mobile Intel HM55 Express Chip, 1066 MHz<br /> - Bộ nhớ: DDR3, 2 GB, 1066 MHz<br /> - M&agrave;n h&igrave;nh: 14 inch HD (1366 x 768)<br /> - Đồ họa: ATI Mobility Radeon HD 5470, 512 MB<br /> - Đĩa cứng: HDD 500 GB, 5400 rpm<br /> - Đĩa quang: DVD Super Multi Double Layer<br /> - Hệ điều h&agrave;nh: Windows 7. Trọng lượng: 2.2 kg</p>', NULL, '0000-00-00', NULL, 1, NULL, 0, 5, 1, 1, 100),
(356, 7, 'Acer Aspire 4820T 452G50Mn (060)  ', '15999000.0000', '<p>- CPU: Intel Core i5 450M, 2.40 GHz<br /> - Bộ nhớ: DDR3, 2 GB. Đĩa cứng: 500 GB<br /> - M&agrave;n h&igrave;nh: 14 inch HD (1366 x 768 pixels)<br /> - Đồ họa: Intel Graphics Media Accelerator HD Graphics<br /> - Đĩa quang: DVD Super Multi Double Layer<br /> - Hệ điều h&agrave;nh: Windows 7 Home Premium. Trọng lượng: 2,1 kg</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 1, 1, 1, 100),
(357, 7, 'Acer Aspire 4820TG ', '15899000.0000', '<p>- CPU: Intel Core i3 370M, 3 MB, L3 Cache<br /> - Bo mạch: Mobile Intel HM55 Express Chip, 1066 MHz<br /> - Bộ nhớ: DDR3, 2 GB, 1066 MHz<br /> - M&agrave;n h&igrave;nh: 14 inch HD (1366 x 768)<br /> - Đồ họa: ATI Mobility Radeon HD 5470, 512 MB<br /> - Đĩa cứng: HDD 320 GB, 5400 rpm<br /> - Đĩa quang: DVD Super Multi Double Layer</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 1, 1, 1, 100),
...
(362, 7, 'Acer Aspire 4738G 452G50M ', '14799000.0000', '<p>- CPU: Intel Core i5 450M, 2.40 GHz<br /> - Bộ nhớ: DDR3, 2 GB. Đĩa cứng: 500 GB<br /> - M&agrave;n h&igrave;nh: 14 inch HD (1366 x 768 pixels)<br /> - Đồ họa: ATI Mobility Radeon HD 5470<br /> - Đĩa quang: DVD Super Multi Double Layer<br /> - Hệ điều h&agrave;nh: Linux. Trọng lượng: 2,1 kg</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 16, 1, 1, 100),
...
(364, 7, 'Acer Aspire 4820TG 452G50 (219) ', '16899000.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(370, 7, 'Acer Aspire 4820T 372G32Mn (232)  ', '14999000.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
(371, 7, 'Acer Aspire 4738G 452G50Mn (020)  ', '14799000.0000', NULL, NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(454, 7, 'Samsung N143 DP01VN  ', '6499000.0000', '<p>- CPU: Intel Atom 450, 1.66 GHz, 512 KB Cache<br />- Bộ nhớ: 1 GB.&nbsp; Đĩa cứng: 160 GB<br />- M&agrave;n h&igrave;nh: 10.1 inch WSVGA (1024 x 600 px)<br />- Đồ họa: Intel Graphics Media Accelerator (GMA) 3150</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 0, 1, 1, 100),
...
(470, 7, 'Samsung P530 Pro  ', '6400000.0000', '<p>- Bộ xử l&yacute;: Intel &nbsp;Core i3 &nbsp;330M &nbsp;2.13 GHz &nbsp;3 MB, L3 Cache &nbsp;2C / 4T &nbsp; <br />- Bo mạch: Mobile Intel &reg; HM55 Express Chipset &nbsp;1066 MHz &nbsp; <br />- Bộ nhớ: 2 GB &nbsp;DDR3 &nbsp;1066 MHz &nbsp; <br />- Đĩa cứng: HDD &nbsp;250 GB &nbsp;&nbsp; &nbsp;5400 rpm &nbsp; <br />- M&agrave;n h&igrave;nh: 15.6 inch &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;HD (1366 x 768) &nbsp; <br />- Đồ họa: Intel Graphics Media Accelerator HD Graphics &nbsp;- &nbsp;T&iacute;ch hợp &nbsp; <br />- Đĩa quang: DVD&plusmn;RW Dual Layer &nbsp;&nbsp; &nbsp; <br />- Hệ điều h&agrave;nh, phần mềm sẵn c&oacute;/OS: Windows 7 Professional &nbsp; <br />- K&iacute;ch thước &amp; trọng lượng: 2.34&nbsp;&nbsp;</p>', NULL, '0000-00-00', NULL, 2, NULL, 0, 7, 1, 1, 100),
(471, 7, 'Samsung P480 Pro ', '15400000.0000', '<p>- Bộ xử l&yacute;: Intel &nbsp;Core i5 &nbsp;540M &nbsp;2.53 GHz &nbsp;4 MB, L3 Cache &nbsp;2C / 4T &nbsp; <br />- Bo mạch: Mobile Intel &reg; HM55 Express Chipset &nbsp;1066 MHz &nbsp; <br />- Bộ nhớ: 2 GB &nbsp;DDR3 &nbsp;1066 MHz &nbsp; <br />- Đĩa cứng: HDD &nbsp;320 GB &nbsp;&nbsp; &nbsp;5400 rpm &nbsp; <br />- M&agrave;n h&igrave;nh: 14 inch &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;HD (1366 x 768) &nbsp; <br />- Đồ họa: Intel Graphics Media Accelerator HD Graphics &nbsp;- &nbsp;T&iacute;ch hợp &nbsp; <br />- Đĩa quang: - &nbsp;&nbsp; &nbsp; <br />- Hệ điều h&agrave;nh, phần mềm sẵn c&oacute;/OS: Windows 7 &nbsp; <br />- K&iacute;ch thước &amp; trọng lượng: 2.22&nbsp;&nbsp;</p>\r\n<p>&nbsp;</p>', NULL, '0000-00-00', NULL, 99, NULL, 0, 5, 1, 1, 100),
(472, 7, 'Samsung RF510  ', '24350000.0000', '<p>- CPU: Intel Core i5 460M, 2.53 GHz, 3 MB Cache<br />- Bộ nhớ: 4 GB. Đĩa cứng: 640 GB<br />- M&agrave;n h&igrave;nh: 15.6 inch HD (1366 x 768)<br />- Đồ họa: NVIDIA GeForce GT 330M<br />- Đĩa quang: Bluray Combo<br />- Hệ điều h&agrave;nh: Windows 7 Home Premium. Trọng lượng: 2.6 kg</p>\r\n<p>&nbsp;</p>', NULL, '0000-00-00', NULL, 100, NULL, 0, 4, 0, 1, 100),
(473, 73, 'Samsung RF710', '6400000.0000', '<h2 data-field=\"sapo\" style=\"margin: 0px 0px 20px; padding: 0px; list-style: none; border: 0px; font-size: 15px; outline: none; color: rgb(82, 80, 80); font-weight: bold; font-family: Tahoma;\">Những sáng kiến mà có lẽ chỉ có các game thủ Việt mới nghĩ ra được là đây.</h2><div id=\"admzonek9yy7w7l\" style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; font-size: 12px; outline: none; color: rgb(51, 51, 51); font-family: Tahoma;\"></div><ul class=\"relate-news\" style=\"margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding: 0px; list-style: none; border: 0px; font-size: 12px; outline: none; color: rgb(51, 51, 51); font-family: Tahoma;\"></ul><div data-check-position=\"gamek_detail_position_start\" style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; font-size: 12px; outline: none; color: rgb(51, 51, 51); font-family: Tahoma;\"></div><div class=\"rightdetail_content\" data-field=\"body\" style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; font-variant-numeric: normal; font-variant-east-asian: normal; font-stretch: normal; font-size: 17px; line-height: 23px; font-family: &quot;Times New Roman&quot;; outline: none; color: rgb(51, 51, 51);\"><p style=\"margin-bottom: 0px; padding: 0px 0px 20px; list-style: none; border: 0px; outline: none;\">Người Việt luôn rất giỏi sáng tạo, và&nbsp;đặc biệt, các game thủ Việt thì càng là bậc thầy của việc \"vượt khó\". Nếu như thời xưa, các phần mềm auto chưa ra&nbsp;đời thì riêng màn \"cắm chuột\"&nbsp;để train MU Online&nbsp;đã trở thành bất hủ thì sau này, không&nbsp;ít lần chúng ta lại&nbsp;được một phen nể phục với những sáng kiến không có giới hạn tới từ các game thủ Việt,&nbsp;điển hình như các trường hợp dưới&nbsp;đây.</p><p style=\"margin-bottom: 0px; padding: 0px 0px 20px; list-style: none; border: 0px; outline: none;\"><b style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\">Máy tính \"độ\" tivi cổ&nbsp;điển</b></p><p style=\"margin-bottom: 0px; padding: 0px 0px 20px; list-style: none; border: 0px; outline: none;\">Dùng màn hình TV cổ&nbsp;điển&nbsp;để làm máy tính -&nbsp;điều này có lẽ không phải ai cũng nghĩ tới mà ngay cả nghĩ tới thì cũng chưa chắc&nbsp;đã làm ra&nbsp;được.&nbsp;Ấy thế nhưng, cuối cùng thì \"sản phẩm\" này cũng ra&nbsp;đời và trên hết, nó&nbsp;được tạo ra bởi một người Việt.</p><div class=\"VCSortableInPreviewMode\" type=\"Photo\" style=\"margin: 0px 0px 10px; padding: 0px; list-style: none; border: 0px; outline: none; font-style: italic; text-align: center;\"><div style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\"><a href=\"https://gamek.mediacdn.vn/133514250583805952/2021/6/28/photo-1-1624883811889204583143.jpg\" data-fancybox-group=\"img-lightbox\" title=\"Tivi thì cổ nhưng Windows lại xịn nhé\" target=\"_blank\" class=\"detail-img-lightbox\" style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\"><img src=\"https://gamek.mediacdn.vn/thumb_w/640/133514250583805952/2021/6/28/photo-1-1624883811889204583143.jpg\" id=\"img_333949707083911168\" w=\"690\" h=\"518\" alt=\"Máy tính độ tivi cổ và những màn sáng tạo đầy bất ngờ, ngẫu hứng khiến ai cũng phải nể phục của các game thủ Việt - Ảnh 1.\" title=\"Máy tính độ tivi cổ và những màn sáng tạo đầy bất ngờ, ngẫu hứng khiến ai cũng phải nể phục của các game thủ Việt - Ảnh 1.\" rel=\"lightbox\" photoid=\"333949707083911168\" type=\"photo\" data-original=\"https://gamek.mediacdn.vn/133514250583805952/2021/6/28/photo-1-1624883811889204583143.jpg\" width=\"\" height=\"\" class=\"lightbox-content\" style=\"margin: 0px; padding: 0px; list-style: none; font-size: 0px; outline: none; color: transparent; max-width: 100%;\"></a></div><div class=\"PhotoCMS_Caption\" style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none; min-height: 0px;\"><p data-placeholder=\"[nhập chú thích]\" class=\"\" style=\"margin-top: 10px; margin-bottom: 0px; padding: 0px 0px 20px; list-style: none; border: 0px; outline: none;\">Tivi thì cổ nhưng Windows lại xịn nhé</p></div></div></div>', NULL, '0000-00-00', '2021-07-01', 100, NULL, 0, 0, 0, 0, 100);
INSERT INTO `fs_product` (`id`, `category_id`, `name`, `price`, `desc`, `detail`, `created_at`, `updated_at`, `qty`, `note`, `sold`, `view`, `active`, `status`, `user_id`) VALUES
(528, 9, 'Moc moc', '31231.0000', '&amp;amp;lt;div id=\"maybemiss\" class=\"page-wrapper\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 20px 0px 0px -550px; padding: 0px; border: 0px; font-size: 12px; vertical-align: baseline; text-size-adjust: 100%; float: left; position: relative; clear: both; z-index: 99; width: 1100px; left: 717.2px; font-family: Arial, sans-serif; background-image: initial !important; background-position: initial !important; background-size: initial !important; background-repeat: initial !important; background-attachment: initial !important; background-origin: initial !important; background-clip: initial !important;\"&amp;amp;gt;&amp;amp;lt;section class=\"section z-missed-articles\" id=\"maybeyoumissed\" data-count=\"4\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 0px 40px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; width: 1100px; float: left; position: relative; font-family: Arial;\"&amp;amp;gt;&amp;amp;lt;header class=\"section-title\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 0px 20px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;h3 style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 6px 0px 4px; padding: 0px 15px 0px 20px; border: 0px; font-size: 2em; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: 600; color: rgb(0, 0, 0); display: inline-block; position: relative; text-transform: uppercase;\"&amp;amp;gt;CÓ THỂ BẠN BỎ LỠ&amp;amp;lt;/h3&amp;amp;gt;&amp;amp;lt;/header&amp;amp;gt;&amp;amp;lt;div class=\"article-list has-four-items\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; float: left; width: 1100px; display: flex;\"&amp;amp;gt;&amp;amp;lt;article class=\"article-item \" article-id=\"1233125\" data-tracker=\"zingweb_home_maybeyoumissed1\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 30px 0px 0px; padding: 10px 0px 15px; border-width: 1px 0px; border-top-style: solid; border-right-style: initial; border-bottom-style: solid; border-left-style: initial; border-top-color: rgb(238, 238, 238); border-right-color: initial; border-bottom-color: rgb(238, 238, 238); border-left-color: initial; border-image: initial; font-size: 1.2rem; vertical-align: baseline; background: transparent; text-size-adjust: 100%; float: left; position: relative; width: 252.5px; font-family: Roboto, Ubuntu, sans-serif; line-height: 1.4;\"&amp;amp;gt;&amp;amp;lt;header style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; border: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;p class=\"article-category\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/thoi-su.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 12px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(85, 85, 85); cursor: pointer; font-weight: bold; text-transform: uppercase;\"&amp;amp;gt;XÃ HỘI&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;p class=\"article-title\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; font-size: 1em; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/thu-tuong-quyet-dinh-bo-sung-kinh-phi-mua-61-trieu-lieu-vaccine-post1233125.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 5px 0px 0px; padding: 0px; font-size: 18px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(0, 0, 0); cursor: pointer; line-height: 1.39;\"&amp;amp;gt;Thủ tướng quyết định bổ sung kinh phí mua 61 triệu liều vaccine&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;/header&amp;amp;gt;&amp;amp;lt;p class=\"article-publish\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-top: 10px; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(171, 171, 171);\"&amp;amp;gt;12:09 hôm qua&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;img data-src=\"//log.zingnews.vn/imps?type=article&amp;amp;amp;amp;appid=zingweb&amp;amp;amp;amp;id=1233125&amp;amp;amp;amp;pos=zingweb_home_maybeyoumissed1\" class=\"tracking\" alt=\"\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden; display: block; z-index: -1;\"&amp;amp;gt;&amp;amp;lt;/article&amp;amp;gt;&amp;amp;lt;article class=\"article-item \" article-id=\"1232820\" data-tracker=\"zingweb_home_maybeyoumissed2\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 30px 0px 0px; padding: 10px 0px 15px; border-width: 1px 0px; border-top-style: solid; border-right-style: initial; border-bottom-style: solid; border-left-style: initial; border-top-color: rgb(238, 238, 238); border-right-color: initial; border-bottom-color: rgb(238, 238, 238); border-left-color: initial; border-image: initial; font-size: 1.2rem; vertical-align: baseline; background: transparent; text-size-adjust: 100%; float: left; position: relative; width: 252.5px; font-family: Roboto, Ubuntu, sans-serif; line-height: 1.4;\"&amp;amp;gt;&amp;amp;lt;header style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; border: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;p class=\"article-category\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/the-thao.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 12px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(85, 85, 85); cursor: pointer; font-weight: bold; text-transform: uppercase;\"&amp;amp;gt;THỂ THAO&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;p class=\"article-title\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; font-size: 1em; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/tuyen-ukraine-viet-cau-chuyen-co-tich-tai-euro-post1232820.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 5px 0px 0px; padding: 0px; font-size: 18px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(0, 0, 0); cursor: pointer; line-height: 1.39;\"&amp;amp;gt;Tuyển Ukraine viết câu chuyện cổ tích tại Euro&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;/header&amp;amp;gt;&amp;amp;lt;p class=\"article-publish\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-top: 10px; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(171, 171, 171);\"&amp;amp;gt;22:05 Thứ 3, 29/06&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;img data-src=\"//log.zingnews.vn/imps?type=article&amp;amp;amp;amp;appid=zingweb&amp;amp;amp;amp;id=1232820&amp;amp;amp;amp;pos=zingweb_home_maybeyoumissed2\" class=\"tracking\" alt=\"\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden; display: block; z-index: -1;\"&amp;amp;gt;&amp;amp;lt;/article&amp;amp;gt;&amp;amp;lt;article class=\"article-item  type-video\" article-id=\"1233107\" data-tracker=\"zingweb_home_maybeyoumissed3\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 30px 0px 0px; padding: 10px 0px 15px; border-width: 1px 0px; border-top-style: solid; border-right-style: initial; border-bottom-style: solid; border-left-style: initial; border-top-color: rgb(238, 238, 238); border-right-color: initial; border-bottom-color: rgb(238, 238, 238); border-left-color: initial; border-image: initial; font-size: 1.2rem; vertical-align: baseline; background: transparent; text-size-adjust: 100%; float: left; position: relative; width: 252.5px; font-family: Roboto, Ubuntu, sans-serif; line-height: 1.4;\"&amp;amp;gt;&amp;amp;lt;header style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; border: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;p class=\"article-category\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/thoi-su.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 12px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(85, 85, 85); cursor: pointer; font-weight: bold; text-transform: uppercase;\"&amp;amp;gt;XÃ HỘI&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;p class=\"article-title\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; font-size: 1em; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif;\"&amp;amp;gt;&amp;amp;amp;nbsp;&amp;amp;lt;a href=\"https://zingnews.vn/video-hien-truong-vu-chay-can-nha-3-tang-o-tphcm-post1233107.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 5px 0px 0px; padding: 0px; font-size: 18px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(0, 0, 0); cursor: pointer; line-height: 1.39;\"&amp;amp;gt;Hiện trường vụ cháy căn nhà 3 tầng ở TP.HCM&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;/header&amp;amp;gt;&amp;amp;lt;p class=\"article-publish\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-top: 10px; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(171, 171, 171);\"&amp;amp;gt;11:23 hôm qua&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;img data-src=\"//log.zingnews.vn/imps?type=article&amp;amp;amp;amp;appid=zingweb&amp;amp;amp;amp;id=1233107&amp;amp;amp;amp;pos=zingweb_home_maybeyoumissed3\" class=\"tracking\" alt=\"\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden; display: block; z-index: -1;\"&amp;amp;gt;&amp;amp;lt;/article&amp;amp;gt;&amp;amp;lt;article class=\"article-item \" article-id=\"1232478\" data-tracker=\"zingweb_home_maybeyoumissed4\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 10px 0px 15px; border-width: 1px 0px; border-top-style: solid; border-right-style: initial; border-bottom-style: solid; border-left-style: initial; border-top-color: rgb(238, 238, 238); border-right-color: initial; border-bottom-color: rgb(238, 238, 238); border-left-color: initial; border-image: initial; font-size: 1.2rem; vertical-align: baseline; background: transparent; text-size-adjust: 100%; float: left; position: relative; width: 252.5px; font-family: Roboto, Ubuntu, sans-serif; line-height: 1.4;\"&amp;amp;gt;&amp;amp;lt;header style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; border: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;p class=\"article-category\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/thoi-su.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 12px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(85, 85, 85); cursor: pointer; font-weight: bold; text-transform: uppercase;\"&amp;amp;gt;XÃ HỘI&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;p class=\"article-title\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-bottom: 0px; padding: 0px; border: 0px; font-size: 1em; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif;\"&amp;amp;gt;&amp;amp;lt;a href=\"https://zingnews.vn/tphcm-can-tinh-viec-dieu-tri-f0-tai-nha-khi-so-ca-nhiem-tang-cao-post1232478.html\" style=\"text-rendering: geometricprecision; outline: none; -webkit-font-smoothing: antialiased; margin: 5px 0px 0px; padding: 0px; font-size: 18px; vertical-align: baseline; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; color: rgb(0, 0, 0); cursor: pointer; line-height: 1.39;\"&amp;amp;gt;\'TP.HCM cần tính việc điều trị F0 tại nhà khi số ca nhiễm tăng cao\'&amp;amp;lt;/a&amp;amp;gt;&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;/header&amp;amp;gt;&amp;amp;lt;p class=\"article-publish\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin-top: 10px; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; font-weight: bold; color: rgb(171, 171, 171);\"&amp;amp;gt;03:21 hôm qua&amp;amp;lt;/p&amp;amp;gt;&amp;amp;lt;img data-src=\"//log.zingnews.vn/imps?type=article&amp;amp;amp;amp;appid=zingweb&amp;amp;amp;amp;id=1232478&amp;amp;amp;amp;pos=zingweb_home_maybeyoumissed4\" class=\"tracking\" alt=\"\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px; padding: 0px; font-size: 19.2px; vertical-align: baseline; background: transparent; text-size-adjust: 100%; position: absolute; top: 0px; left: 0px; width: 1px; height: 1px; overflow: hidden; display: block; z-index: -1;\"&amp;amp;gt;&amp;amp;lt;/article&amp;amp;gt;&amp;amp;lt;/div&amp;amp;gt;&amp;amp;lt;/section&amp;amp;gt;&amp;amp;lt;/div&amp;amp;gt;&amp;amp;lt;section id=\"section-magazine\" class=\"section section-magazine\" data-count=\"31\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 0px 30px; padding: 40px 0px 30px; border: 0px; font-size: 12px; vertical-align: baseline; background: rgb(238, 238, 238); text-size-adjust: 100%; width: 1434.4px; float: left; position: relative; font-family: Arial, sans-serif;\"&amp;amp;gt;&amp;amp;lt;div class=\"page-wrapper\" style=\"text-rendering: geometricprecision; outline: 0px; -webkit-font-smoothing: antialiased; margin: 0px 0px 0px -560px; padding: 0px; border: 0px; vertical-align: baseline; text-size-adjust: 100%; float: left; position: relative; clear: both; z-index: 99; width: 1120px; left: 717.2px; overflow: visible; background: transparent !important;\"&amp;amp;gt;&amp;amp;lt;/div&amp;amp;gt;&amp;amp;lt;/section&amp;amp;gt;', 'Detail', '2021-07-01', '2021-07-01', 33, 'Note', 0, 0, 0, 0, 100);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `fs_product_img`
--

DROP TABLE IF EXISTS `fs_product_img`;
CREATE TABLE IF NOT EXISTS `fs_product_img` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `fs_product_img`
--

INSERT INTO `fs_product_img` (`id`, `product_id`, `url`, `alt`, `order`, `active`, `created_at`, `updated_at`) VALUES
(1, 1, 'Nokia_N81.jpg', 'Nokia N8', 1, 1, NULL, NULL),
(2, 2, 'N900.jpg', 'Nokia N900', 1, 1, NULL, NULL),
(3, 4, '6700_gold.jpg', 'Nokia 6700 classic gold', 1, 1, NULL, NULL),
(4, 5, 'n97.jpg', 'Nokia N97', 1, 1, NULL, NULL),
(5, 6, 'N97_mini.jpg', 'Nokia N97 mini Navi', 1, 1, NULL, NULL),
(6, 7, 'nokia_C7.jpg', 'Nokia C7', 1, 1, NULL, NULL),
(7, 8, 'N86.jpg', 'Nokia N86', 1, 1, NULL, NULL),
(8, 9, 'E72.jpg', 'Nokia E72 Navi', 1, 1, NULL, NULL),
(9, 10, 'E72_1.jpg', 'Nokia E72', 1, 1, NULL, NULL),
(10, 11, 'E72-white.jpg', 'Nokia E72 white', 1, 1, NULL, NULL),
(11, 12, 'x6_16.jpg', 'Nokia X6 16GB ', 1, 1, NULL, NULL),
(12, 13, 'x6_16_1.jpg', 'Nokia X6 Navi', 1, 1, NULL, NULL),
(13, 14, 'X6-8G.jpg', 'Nokia X6 8GB', 1, 1, NULL, NULL),
(14, 15, 'C6.jpg', 'Nokia C6', 1, 1, NULL, NULL),
(15, 16, 'E75.jpg', 'Nokia E75', 1, 1, NULL, NULL),
(16, 17, '5800_nav.jpg', 'Nokia 5800 Navi  ', 1, 1, NULL, NULL),
(17, 18, 'Nokia-5800.jpg', 'Nokia 5800 XpressMussic 4GB', 1, 1, NULL, NULL),
(18, 19, 'nokia_e71.jpg', 'Nokia E71', 1, 1, NULL, NULL),
(19, 20, 'no_e66.jpg', 'Nokia E66', 1, 1, NULL, NULL),
(20, 21, 'nokia_E5.jpg', 'Nokia E5', 1, 1, NULL, NULL),
(21, 22, 'nokia_E5_1.jpg', 'Nokia 6700 classic illuvial pink', 1, 1, NULL, NULL),
(22, 23, '6700_pink.jpg', 'Nokia 6700 classic illuvial pink   ', 1, 1, NULL, NULL),
(23, 24, 'no_E52.jpg', 'Nokia E52 Navi ', 1, 1, NULL, NULL),
(24, 25, '6700_cla.jpg', 'Nokia 6700 classic', 1, 1, NULL, NULL),
(25, 26, 'nokia_c5-03.jpg', 'Nokia C5-03', 1, 1, NULL, NULL),
(26, 27, 'Nokia_6760.jpg', 'Nokia 6760 slide', 1, 1, NULL, NULL),
(27, 28, '000000000Nokia_5530pink.jpg', 'Nokia 5530 illuvial pink', 1, 1, NULL, NULL),
(28, 29, 'Nokia 5530 XpressMusic.jpg', 'Nokia 5530 XpressMusic   ', 1, 1, NULL, NULL),
(29, 30, '7610_sup.jpg', 'Nokia 7610 supernova ', 1, 1, NULL, NULL),
(30, 31, 'Nokia_5233.jpg', 'Nokia 5233   ', 1, 1, NULL, NULL),
(31, 32, 'nokia_x3.jpg', 'Nokia X3  ', 1, 1, NULL, NULL),
(32, 33, 'nokia_5250_gray.jpg', 'Nokia 5250', 1, 1, NULL, NULL),
(33, 34, 'no_c3.jpg', 'Nokia C3', 1, 1, NULL, NULL),
(34, 35, '0Nokia_6303i.jpg', 'Nokia 6303i classic', 1, 1, NULL, NULL),
(35, 36, '0Nokia_7230.jpg', 'Nokia 7230  ', 1, 1, NULL, NULL),
(36, 37, 'Nokia_X2.jpg', 'Nokia X2', 1, 1, NULL, NULL),
(37, 38, 'Nokia-6600fold0.jpg', 'Nokia 6600 fold ', 1, 1, NULL, NULL),
(38, 39, 'Nokia 5130 XpressMusic.jpg', 'Nokia 5130 XpressMusic', 1, 1, NULL, NULL),
(39, 40, 'Nokia_X2-01.jpg', 'Nokia X2-01', 1, 1, NULL, NULL),
(40, 41, 'Nokia 2730 classic.jpg', 'Nokia 2730 classic', 1, 1, NULL, NULL),
(41, 42, 'Nokia 2700.jpg', 'Nokia 2700', 1, 1, NULL, NULL),
(42, 43, 'Nokia_2690.jpg', 'Nokia 2690', 1, 1, NULL, NULL),
(43, 44, 'Nokia_C1-01.jpg', 'Nokia C1-01', 1, 1, NULL, NULL),
(44, 45, 'Nokia 5030.jpg', 'Nokia 5030', 1, 1, NULL, NULL),
(45, 46, 'Nokia_C1_00.jpg', 'Nokia C1-00', 1, 1, NULL, NULL),
(46, 47, 'Nokia_1800.jpg', 'Nokia 1800', 1, 1, NULL, NULL),
(47, 48, 'Nokia_1616.jpg', 'Nokia 1616', 1, 1, NULL, NULL),
(48, 49, 'Nokia-1208b.jpg', 'Nokia 1208', 1, 1, NULL, NULL),
(49, 50, 'Nokia-1280.jpg', 'Nokia 1280', 1, 1, NULL, NULL),
(50, 51, 'X720_mitole.jpg', 'Motorola XT720 Milestone', 1, 1, NULL, NULL),
(51, 52, 'milse_tone.jpg', 'Motorola MILESTONE  ', 1, 1, NULL, NULL),
(52, 53, 'BACKFLIP.jpg', 'Motorola MB300 BACKFLIP   ', 1, 1, NULL, NULL),
(53, 54, 'motorola_EM300.jpg', 'Motorola EX300  ', 1, 1, NULL, NULL),
(54, 55, 'motorola-cd920.gif', 'Motorola CD920', 1, 1, NULL, NULL),
(55, 56, 'motorola-cd930.gif', 'Motorola CD930    ', 1, 1, NULL, NULL),
(56, 57, 'BACKFLIP_1.jpg', 'Motorola MB300 BACKFLIP   ', 1, 1, NULL, NULL),
(57, 58, 'motorola-d520.gif', 'Motorola D520 ', 1, 1, NULL, NULL),
(58, 59, 'motorola_EM300_1.jpg', 'Motorola EX300', 1, 1, NULL, NULL),
(59, 60, 'motorola-e360.gif', 'Motorola E360', 1, 1, NULL, NULL),
(60, 61, 'Motorola_WX295.jpg', 'Motorola WX295   ', 1, 1, NULL, NULL),
(61, 62, 'motorola-e365.gif', 'Motorola E365  ', 1, 1, NULL, NULL),
(62, 63, 'Moto_WX290.jpg', 'Motorola WX290     * Thiết kế dạng thanh trẻ trung', 1, 1, NULL, NULL),
(63, 64, 'motorola-e380.gif', 'Motorola E380 ', 1, 1, NULL, NULL),
(64, 65, 'Motorola_WX260.jpg', 'Motorola WX260   ', 1, 1, NULL, NULL),
(65, 66, 'motorola-e390.gif', 'Motorola E390', 1, 1, NULL, NULL),
(66, 67, 'Motorola_WX180.jpg', 'Motorola WX180   ', 1, 1, NULL, NULL),
(67, 68, 'motorola-m3188.gif', 'Motorola M3188 ', 1, 1, NULL, NULL),
(68, 69, 'Motorola_WX181.jpg', 'Motorola WX181 ', 1, 1, NULL, NULL),
(69, 70, 'motorola-m3288.gif', 'Motorola M3288 ', 1, 1, NULL, NULL),
(70, 71, 'Motorola-V3i-D_G-Gold6.jpg', 'Motorola RAZR V3i D&G Gold ', 1, 1, NULL, NULL),
(71, 72, 'motorola-m3588.gif', 'Motorola M3588', 1, 1, NULL, NULL),
(72, 73, '', 'Motorola C350', 1, 1, NULL, NULL),
(73, 74, '', 'Motorola A6188', 1, 1, NULL, NULL),
(74, 75, 'motorola-c330.jpg', 'Motorola C330  ', 1, 1, NULL, NULL),
(75, 76, 'motorola-a760.gif', 'Motorola A760', 1, 1, NULL, NULL),
(76, 77, 'LG_GS500.jpg', 'LG GS500 Cookie Plus', 1, 1, NULL, NULL),
(77, 78, 'GD880.jpg', 'LG GD880 Mini', 1, 1, NULL, NULL),
(78, 79, 'GT350.jpg', 'LG Wink Wifi GT350i ', 1, 1, NULL, NULL),
(79, 80, 'LG_GD510.jpg', 'LG GD510 Pop', 1, 1, NULL, NULL),
(80, 81, 'bl40.jpg', 'LG BL40 New Chocolate ', 1, 1, NULL, NULL),
(81, 82, 'LG-GS290.jpg', 'LG GS290 Cookie Fresh   ', 1, 1, NULL, NULL),
(82, 83, 'optic_one.jpg', 'LG Optimus One P500 ', 1, 1, NULL, NULL),
(83, 84, 'LG-GD350.jpg', 'LG GD350', 1, 1, NULL, NULL),
(84, 85, 'LG-GT540.jpg', 'LG GT540 Optimus', 1, 1, NULL, NULL),
(85, 86, 'LG_S310.jpg', 'LG S310 ', 1, 1, NULL, NULL),
(86, 87, 'LG_GU285.jpg', 'LG GU285', 1, 1, NULL, NULL),
(87, 88, 'GW620.jpg', 'LG GW620', 1, 1, NULL, NULL),
(88, 89, 'LG_GW300.jpg', 'LG GW300', 1, 1, NULL, NULL),
(89, 90, '0LG_GX500.jpg', 'LG GX500 ', 1, 1, NULL, NULL),
(90, 91, 'LG_GW305.jpg', 'LG GW305', 1, 1, NULL, NULL),
(91, 92, 'LG_GT505.jpg', 'LG GT505', 1, 1, NULL, NULL),
(92, 93, 'LG_T300.jpg', 'LG Wink Touch T300   ', 1, 1, NULL, NULL),
(93, 94, 'GM360i.jpg', 'LG GM360i ', 1, 1, NULL, NULL),
(94, 95, 'lg-600.gif', 'LG LG 600', 1, 1, NULL, NULL),
(95, 96, 'LG-GD580.jpg', 'LG GD580 Lollipop', 1, 1, NULL, NULL),
(96, 97, 'LG-KM550E.jpg', 'LG Cookie 3G KM555', 1, 1, NULL, NULL),
(97, 98, '0LG_GX200.jpg', 'LG GX200', 1, 1, NULL, NULL),
(98, 99, 'LG_GU230.jpg', 'LG GU230 ', 1, 1, NULL, NULL),
(99, 100, 'lg-510w.gif', 'LG LG 510w ', 1, 1, NULL, NULL),
(100, 101, 'lg-500.gif', 'LG LG 500', 1, 1, NULL, NULL),
(101, 102, 'LG_C100.jpg', 'LG Wink C100', 1, 1, NULL, NULL),
(102, 103, 'lg-200.gif', 'LG LG 200   ', 1, 1, NULL, NULL),
(103, 104, 'LG_GS155.jpg', 'LG GS155', 1, 1, NULL, NULL),
(104, 105, '', 'LG Chocolate Gold KE800   ', 1, 1, NULL, NULL),
(105, 106, 'LG_GS102.jpg', 'LG GS102', 1, 1, NULL, NULL),
(106, 107, 'K-Touch_E62.jpg', 'K-Touch E62 ', 1, 1, NULL, NULL),
(107, 108, 'K-Touch_H677.jpg', 'K-Touch H677 ', 1, 1, NULL, NULL),
(108, 109, 'ktouch_X90.jpg', 'K-Touch X90', 1, 1, NULL, NULL),
(109, 110, 'K- Touch Q160.jpg', 'K Touch Q160   ', 1, 1, NULL, NULL),
(110, 111, 'K-Touch_H999.jpg', 'K-Touch H999', 1, 1, NULL, NULL),
(111, 112, 'K-tuochB896.jpg', 'K-Touch B896 white   ', 1, 1, NULL, NULL),
(112, 113, 'K-Touch_H877.jpg', 'K-Touch H877', 1, 1, NULL, NULL),
(113, 114, 'K-tuochD173red.jpg', 'K-Touch D173 red   ', 1, 1, NULL, NULL),
(114, 115, 'K-Touch E61.jpg', 'K-Touch E61   ', 1, 1, NULL, NULL),
(115, 116, 'K-touch_V388.jpg', 'K-Touch V388 ', 1, 1, NULL, NULL),
(116, 117, 'K- Touch V908.jpg', 'K Touch V908   ', 1, 1, NULL, NULL),
(117, 118, 'K-touch_H888.jpg', 'K-Touch H888 ', 1, 1, NULL, NULL),
(118, 119, 'k-Touch_M600.jpg', 'K-Touch M600   ', 1, 1, NULL, NULL),
(119, 120, 'K-Touch_H899.jpg', 'K-Touch H899 ', 1, 1, NULL, NULL),
(120, 121, 'K-Touch E606.jpg', 'K-Touch E606   ', 1, 1, NULL, NULL),
(121, 122, 'K-Touch_M606.jpg', 'K-Touch M606', 1, 1, NULL, NULL),
(122, 123, 'k-touch_A610.jpg', 'K-Touch A610 ', 1, 1, NULL, NULL),
(123, 124, 'K- Touch E68.jpg', 'K Touch E68   ', 1, 1, NULL, NULL),
(124, 125, 'k-touch_H688.jpg', 'K-Touch H688 ', 1, 1, NULL, NULL),
(125, 126, 'k-touch_H699.jpg', 'K-Touch H699', 1, 1, NULL, NULL),
(126, 127, 'galaxy_tab.jpg', 'Samsung Galaxy Tab P1000', 1, 1, NULL, NULL),
(127, 128, 'samsung_s8530.jpg', 'Samsung S8530 Wave II   ', 1, 1, NULL, NULL),
(128, 129, 'S8500.jpg', 'Samsung S8500 Wave   ', 1, 1, NULL, NULL),
(129, 130, 'S8500_1.jpg', 'Samsung I5700 Galaxy Spica   ', 1, 1, NULL, NULL),
(130, 131, 'i5700.jpg', 'Samsung I5700 Galaxy Spica   ', 1, 1, NULL, NULL),
(131, 132, 'samsung_s7372e.jpg', 'Samsung Wave S7233   ', 1, 1, NULL, NULL),
(132, 133, 'samsung_i5800.jpg', 'Samsung Galaxy 3 i5801   ', 1, 1, NULL, NULL),
(133, 134, 'B7330.jpg', 'Samsung B7330 OmniaPRO   ', 1, 1, NULL, NULL),
(134, 135, 'Samsung-S5560.jpg', 'Samsung S5560   ', 1, 1, NULL, NULL),
(135, 136, 'samsung_wave575.jpg', 'Samsung Wave S5753   ', 1, 1, NULL, NULL),
(136, 137, 'Samsung_B5310.jpg', 'Samsung B5310 CorbyPRO   ', 1, 1, NULL, NULL),
(137, 138, 'Samsung_i5500.jpg', 'Samsung i5503 Corby Smart  ', 1, 1, NULL, NULL),
(138, 139, 'Samsung B7320 OmniaPRO.jpg', 'Samsung B7320 OmniaPRO', 1, 1, NULL, NULL),
(139, 140, '0Samsung_S5620.jpg', 'Samsung S5620 Monte ', 1, 1, NULL, NULL),
(140, 141, 'Samsung_S5233TV.jpg', 'Samsung Star S5233TV   ', 1, 1, NULL, NULL),
(141, 142, 'Samsung_S5233w.jpg', 'Samsung Star S5233W   ', 1, 1, NULL, NULL),
(142, 143, 's5350.jpg', 'Samsung S5350 Shark   ', 1, 1, NULL, NULL),
(143, 144, 'b3410w.jpg', 'Samsung B3410W Ch@t   ', 1, 1, NULL, NULL),
(144, 145, 's5233.jpg', 'Samsung Star S5233   ', 1, 1, NULL, NULL),
(145, 146, 'b3410.jpg', 'Samsung B3410 CorbyChat   ', 1, 1, NULL, NULL),
(146, 147, 's3653.jpg', 'Samsung S3653W Corby   ', 1, 1, NULL, NULL),
(147, 148, 'S3353.jpg', 'Samsung S3353 Ch@t 335   ', 1, 1, NULL, NULL),
(148, 149, 'Samsung_S3650.jpg', 'Samsung S3653 Corby   ', 1, 1, NULL, NULL),
(149, 150, '0Samsung-C3510.jpg', 'Samsung C3510   ', 1, 1, NULL, NULL),
(150, 151, 'b3210.jpg', 'Samsung B3210 CorbyTXT   ', 1, 1, NULL, NULL),
(151, 152, 'samsung_chat322.jpg', 'Samsung C3222   ', 1, 1, NULL, NULL),
(152, 153, 'Samsung S3500.jpg', 'Samsung S3500   ', 1, 1, NULL, NULL),
(153, 154, '0samsung-s3100.jpg', 'Samsung S3100   ', 1, 1, NULL, NULL),
(154, 155, 'Samsung S3600.jpg', 'Samsung S3600   ', 1, 1, NULL, NULL),
(155, 156, 'Samsung_C3200.jpg', 'Samsung C3200 Monte Bar   ', 1, 1, NULL, NULL),
(156, 157, 'Samsung_C3300.jpg', 'Samsung C3303 Champ   ', 1, 1, NULL, NULL),
(157, 158, 'samsung_e2530.jpg', 'Samsung E2530   ', 1, 1, NULL, NULL),
(158, 159, 'Samsung_E2550.jpg', 'Samsung E2550 Monte Slider   ', 1, 1, NULL, NULL),
(159, 160, 'Samsung E2510.jpg', 'Samsung E2510  ', 1, 1, NULL, NULL),
(160, 161, 'Samsung C3053.jpg', 'Samsung C3053   ', 1, 1, NULL, NULL),
(161, 162, 'Samsung E1360s.jpg', 'Samsung E1360s   ', 1, 1, NULL, NULL),
(162, 163, 'Samsung_E1175T.jpg', 'Samsung E1175T   ', 1, 1, NULL, NULL),
(163, 164, 'Samsung-U6000.jpg', 'Samsung U600   ', 1, 1, NULL, NULL),
(164, 165, 'cayon_E590.jpg', 'Cayon E590   ', 1, 1, NULL, NULL),
(165, 166, 'Cayon_C319.jpg', 'Cayon C319  ', 1, 1, NULL, NULL),
(166, 167, '0Cayon_U7.jpg', 'Cayon U7 ', 1, 1, NULL, NULL),
(167, 168, 'Cayon_i7.jpg', 'Cayon i7', 1, 1, NULL, NULL),
(168, 169, '0Cayon_i6.jpg', 'Cayon i6 ', 1, 1, NULL, NULL),
(169, 170, 'Cayon_E330.jpg', 'Cayon E330  ', 1, 1, NULL, NULL),
(170, 171, 'Cayon_E560.jpg', 'Cayon E560  ', 1, 1, NULL, NULL),
(171, 172, 'Cayon_U6.jpg', 'Cayon U6', 1, 1, NULL, NULL),
(172, 173, 'Cayon_E550.jpg', 'Cayon E550 ', 1, 1, NULL, NULL),
(173, 174, 'cayon_C309i.jpg', 'Cayon C309i ', 1, 1, NULL, NULL),
(174, 175, 'Cayon_C580.jpg', 'Cayon C580', 1, 1, NULL, NULL),
(175, 176, 'cayon_C505.jpg', 'Cayon C505   ', 1, 1, NULL, NULL),
(176, 177, 'Cayon_i8.jpg', 'Cayon i8  ', 1, 1, NULL, NULL),
(177, 178, 'Cayon V850.jpg', 'Cayon V850 ', 1, 1, NULL, NULL),
(178, 179, 'Cayon-C309.jpg', 'Cayon C309   ', 1, 1, NULL, NULL),
(179, 180, 'Cayon_U8.jpg', 'Cayon U8  ', 1, 1, NULL, NULL),
(180, 181, 'Cayon_C318.jpg', 'Cayon C318  ', 1, 1, NULL, NULL),
(181, 182, 'Cayon E530.jpg', 'Cayon E530   ', 1, 1, NULL, NULL),
(182, 183, 'sony_x10.jpg', 'Sony Ericsson XPERIA X10', 1, 1, NULL, NULL),
(183, 184, 'vivaz_pro.jpg', 'Sony Ericsson U8 Vivaz pro', 1, 1, NULL, NULL),
(184, 185, 'sony_aino.jpg', 'Sony Ericsson Aino U10   ', 1, 1, NULL, NULL),
(185, 186, 'U1_satio.jpg', 'Sony Ericsson Satio U1 ', 1, 1, NULL, NULL),
(186, 187, 'sony_x2.jpg', 'Sony Ericsson XPERIA X2', 1, 1, NULL, NULL),
(187, 188, 'vivaz.jpg', 'Sony Ericsson Vivaz ', 1, 1, NULL, NULL),
(188, 189, 'x10mini.jpg', 'Sony Ericsson XPERIA X10 mini ', 1, 1, NULL, NULL),
(189, 190, 'W995.jpg', 'Sony Ericsson W995', 1, 1, NULL, NULL),
(190, 191, 'Sony_X8.jpg', 'Sony Ericsson XPERIA X8', 1, 1, NULL, NULL),
(191, 192, 'j20i.jpg', 'Sony Ericsson J20i Hazel  ', 1, 1, NULL, NULL),
(192, 193, 'J10i2.jpg', 'Sony Ericsson Elm J10i2', 1, 1, NULL, NULL),
(193, 194, 'W980.jpg', 'Sony Ericsson W980 ', 1, 1, NULL, NULL),
(194, 195, 'Sony Ericsson T715.jpg', 'Sony Ericsson T715 ', 1, 1, NULL, NULL),
(195, 196, '0Sony Ericsson W508.jpg', 'Sony Ericsson W508 ', 1, 1, NULL, NULL),
(196, 197, 'SE_T707.jpg', 'Sony Ericsson T707  ', 1, 1, NULL, NULL),
(197, 198, 'Sony Ericsson W890i.jpg', 'Sony Ericsson W890i  ', 1, 1, NULL, NULL),
(198, 199, 'W760.jpg', 'Sony Ericsson W760  ', 1, 1, NULL, NULL),
(199, 200, 'SE_zylo.jpg', 'Sony Ericsson W20i Zylo  ', 1, 1, NULL, NULL),
(200, 201, 'SE-W595.jpg', 'Sony Ericsson W595 ', 1, 1, NULL, NULL),
(201, 202, 'T700.jpg', 'Sony Ericsson T700', 1, 1, NULL, NULL),
(202, 203, 'Sony Ericsson W395.jpg', 'Sony Ericsson W395  ', 1, 1, NULL, NULL),
(203, 204, 'SE_Spiro.jpg', 'Sony Ericsson Spiro W100i', 1, 1, NULL, NULL),
(204, 205, 'w205.jpg', 'Sony Ericsson W205  ', 1, 1, NULL, NULL),
(205, 206, 'sonyericsson-p800.gif', 'Sony Ericsson P800  ', 1, 1, NULL, NULL),
(206, 207, 'Wellcom_A88.jpg', 'WellcoM A88', 1, 1, NULL, NULL),
(207, 208, 'Wellcom_W9229.jpg', 'WellcoM W9229', 1, 1, NULL, NULL),
(208, 209, 'Wellcom_A66.jpg', 'WellcoM A66', 1, 1, NULL, NULL),
(209, 210, 'Wellcom_W3311.jpg', 'WellcoM W3311  ', 1, 1, NULL, NULL),
(210, 211, 'Wellcom_W9119.jpg', 'WellcoM W9119', 1, 1, NULL, NULL),
(211, 212, 'wellcom_w3330.jpg', 'WellcoM W3330  ', 1, 1, NULL, NULL),
(212, 213, 'wellcom_w3112.jpg', 'WellcoM W3112', 1, 1, NULL, NULL),
(213, 214, 'wellcom_w3113.jpg', 'WellcoM W3113', 1, 1, NULL, NULL),
(214, 215, 'wellcom_w3111.jpg', 'WellcoM W3111  ', 1, 1, NULL, NULL),
(215, 216, 'wellcom_w3333.jpg', 'WellcoM W3333  ', 1, 1, NULL, NULL),
(216, 217, 'Wellcom_W3339.jpg', 'WellcoM W3339  ', 1, 1, NULL, NULL),
(217, 218, 'WellcoM-W538.jpg', 'WellcoM W538  ', 1, 1, NULL, NULL),
(218, 219, 'HTC_desireZ.jpg', 'HTC Desire Z', 1, 1, NULL, NULL),
(219, 220, 'HD2.jpg', 'HTC HD2', 1, 1, NULL, NULL),
(220, 221, 'desire.jpg', 'HTC Desire', 1, 1, NULL, NULL),
(221, 222, 'legend_s.jpg', 'HTC Legend', 1, 1, NULL, NULL),
(222, 223, 'magic.jpg', 'HTC Magic ', 1, 1, NULL, NULL),
(223, 224, 'diamond2.jpg', 'HTC Diamond2  ', 1, 1, NULL, NULL),
(224, 225, 'HD_mini.jpg', 'HTC HD mini  ', 1, 1, NULL, NULL),
(225, 226, 'aria.jpg', 'HTC Aria', 1, 1, NULL, NULL),
(226, 227, 'hero.jpg', 'HTC Hero  ', 1, 1, NULL, NULL),
(227, 228, 'Cruise.jpg', 'HTC Touch Cruise T4242  ', 1, 1, NULL, NULL),
(228, 229, 'tattoo.jpg', 'HTC Tattoo  ', 1, 1, NULL, NULL),
(229, 230, 'snap.jpg', 'HTC Snap', 1, 1, NULL, NULL),
(230, 231, 'touch_3G.jpg', 'HTC Touch 3G', 1, 1, NULL, NULL),
(231, 232, 'wilfire.jpg', 'HTC Wildfire  ', 1, 1, NULL, NULL),
(232, 233, 'HTC Vina.jpg', 'HTC Viva T2223  ', 1, 1, NULL, NULL),
(233, 234, '0HTC-Smart.jpg', 'HTC Smart  ', 1, 1, NULL, NULL),
(234, 235, 'HTC_Nexusone.jpg', 'HTC Google Nexus One', 1, 1, NULL, NULL),
(235, 236, 'm770.jpg', 'Mobell M770', 1, 1, NULL, NULL),
(236, 237, 'M760.jpg', 'Mobell M760 ', 1, 1, NULL, NULL),
(237, 238, 'Mobell_M750.jpg', 'Mobell M750  ', 1, 1, NULL, NULL),
(238, 239, 'Mobell_M660.jpg', 'Mobell M660 ', 1, 1, NULL, NULL),
(239, 240, 'Mobell_W660.jpg', 'Mobell MW660  ', 1, 1, NULL, NULL),
(240, 241, 'Mobell_M620.jpg', 'Mobell M620  ', 1, 1, NULL, NULL),
(241, 242, 'Mobell M720.jpg', 'Mobell M720  ', 1, 1, NULL, NULL),
(242, 243, 'Mobell_M560.jpg', 'Mobell M560', 1, 1, NULL, NULL),
(243, 244, 'Mobell_M430.jpg', 'Mobell M430  ', 1, 1, NULL, NULL),
(244, 245, 'Mobell M610.jpg', 'Mobell M610', 1, 1, NULL, NULL),
(245, 246, 'mobell_M530.jpg', 'Mobell M530 ', 1, 1, NULL, NULL),
(246, 247, 'Mobell M520.jpg', 'Mobell M520', 1, 1, NULL, NULL),
(247, 248, 'Mobell_M375.jpg', 'Mobell M375', 1, 1, NULL, NULL),
(248, 249, 'Mobell_M370.jpg', 'Mobell M370 ', 1, 1, NULL, NULL),
(249, 250, 'Mobell_M330.jpg', 'Mobell M330', 1, 1, NULL, NULL),
(250, 251, '0Mobell_M320.jpg', 'Mobell M320', 1, 1, NULL, NULL),
(251, 252, 'mobell_m110.jpg', 'Mobell M110', 1, 1, NULL, NULL),
(252, 253, 'Mobell_M230.jpg', 'Mobell M230', 1, 1, NULL, NULL),
(253, 254, 'Mobell M220.jpg', 'Mobell M220', 1, 1, NULL, NULL),
(254, 255, 'Mobell_M270.jpg', 'Mobell M270', 1, 1, NULL, NULL),
(255, 256, 'M228.jpg', 'Mobell M228', 1, 1, NULL, NULL),
(256, 257, 'mobell_M238.jpg', 'Mobell M238  ', 1, 1, NULL, NULL),
(257, 258, 'Mobell_M260.jpg', 'Mobell M260', 1, 1, NULL, NULL),
(258, 259, 'Mobell_M218.jpg', 'Mobell M218', 1, 1, NULL, NULL),
(259, 260, 'Mobell M190.jpg', 'Mobell M190', 1, 1, NULL, NULL),
(260, 261, 'Lenovo_X1m.jpg', 'Lenovo X1m', 1, 1, NULL, NULL),
(261, 262, 'Lenovo_S700.jpg', 'Lenovo S700', 1, 1, NULL, NULL),
(262, 263, 'Lenovo_P80.jpg', 'Lenovo P80', 1, 1, NULL, NULL),
(263, 264, 'lenovo_i350.jpg', 'Lenovo i350', 1, 1, NULL, NULL),
(264, 265, 'Lenovo_i61.jpg', 'Lenovo i61', 1, 1, NULL, NULL),
(265, 266, 'lenovo_s520.jpg', 'Lenovo S520', 1, 1, NULL, NULL),
(266, 267, 'P629.jpg', 'Lenovo P629 ', 1, 1, NULL, NULL),
(267, 268, 'Lenovo_P50.jpg', 'Lenovo P50', 1, 1, NULL, NULL),
(268, 269, 'Lenovo_P60.jpg', 'Lenovo P60', 1, 1, NULL, NULL),
(269, 270, 'lenovo_A312.jpg', 'Lenovo A312', 1, 1, NULL, NULL),
(270, 271, 'Lenovo_B580.jpg', 'Lenovo P580', 1, 1, NULL, NULL),
(271, 272, 'Lenovo_i300.jpg', 'Lenovo i300  ', 1, 1, NULL, NULL),
(272, 273, 'Lenovo_A310.jpg', 'Lenovo A310 ', 1, 1, NULL, NULL),
(273, 274, 'Lenovo-A332.jpg', 'Lenovo A332', 1, 1, NULL, NULL),
(274, 275, 'Lenovo_A330.jpg', 'Lenovo A330  ', 1, 1, NULL, NULL),
(275, 276, 'lenovo_E228.jpg', 'Lenovo E228', 1, 1, NULL, NULL),
(276, 277, 'Lenovo_E268.jpg', 'Lenovo E268', 1, 1, NULL, NULL),
(277, 278, '00lenovo_E218.jpg', 'Lenovo E218 ', 1, 1, NULL, NULL),
(278, 279, 'Lenovo_E156.jpg', 'Lenovo E156 ', 1, 1, NULL, NULL),
(279, 280, 'Lenovo_A910.jpg', 'Lenovo A910 ', 1, 1, NULL, NULL),
(280, 281, 'Untitled-1vua0.jpg', 'KONKA M526 ', 1, 1, NULL, NULL),
(281, 282, 'Untitled-vua.jpg', 'KONKA C676', 1, 1, NULL, NULL),
(282, 283, 'Untitled-vua4.jpg', 'KONKA D316  ', 1, 1, NULL, NULL),
(283, 284, 'Untitled-vua3.jpg', 'KONKA D363', 1, 1, NULL, NULL),
(284, 285, 'Untitled-vua0.jpg', 'KONKA D169 ', 1, 1, NULL, NULL),
(285, 286, 'Untitled-vua2.jpg', 'KONKA D163', 1, 1, NULL, NULL),
(286, 287, 'F-Mobile_B900.jpg', 'F-Mobile B900', 1, 1, NULL, NULL),
(287, 288, 'FPT_F99_3G.jpg', 'FPT F99 3G ', 1, 1, NULL, NULL),
(288, 289, 'fmobile_f99i.jpg', 'F-Mobile F99i  ', 1, 1, NULL, NULL),
(289, 290, 'F-mobile_B940.jpg', 'F-Mobile B940', 1, 1, NULL, NULL),
(290, 291, 'F-Mobile_F99.jpg', 'F-Mobile F99', 1, 1, NULL, NULL),
(291, 292, 'F-Mobile-B950.jpg', 'F-Mobile B950  ', 1, 1, NULL, NULL),
(292, 293, 'f-mobile_F88.jpg', 'F-Mobile F88 ', 1, 1, NULL, NULL),
(293, 294, 'f-mobile_B930.jpg', 'F-Mobile B930', 1, 1, NULL, NULL),
(294, 295, 'fmobile_C890.jpg', 'F-Mobile C890', 1, 1, NULL, NULL),
(295, 296, 'Fmobile_S800.jpg', 'F-Mobile S800', 1, 1, NULL, NULL),
(296, 297, 'F-mobile_S880i.jpg', 'F-Mobile S880i ', 1, 1, NULL, NULL),
(297, 298, 'fpt_B750.jpg', 'F-Mobile B750 ', 1, 1, NULL, NULL),
(298, 299, 'F-mobile_S700.jpg', 'F-Mobile S700  ', 1, 1, NULL, NULL),
(299, 300, 'F-mobile_B850.jpg', 'F-Mobile B850', 1, 1, NULL, NULL),
(300, 301, 'F-Mobile-B880.jpg', 'F-Mobile B880  ', 1, 1, NULL, NULL),
(301, 302, 'F-mobile_B650.jpg', 'F-Mobile B650', 1, 1, NULL, NULL),
(302, 303, 'fmobie_b730.jpg', 'F-Mobile B730', 1, 1, NULL, NULL),
(303, 304, 'F-Mobie_B720.jpg', 'F-Mobile B720', 1, 1, NULL, NULL),
(304, 305, 'F-Mobile_B700.jpg', 'F-Mobile B700', 1, 1, NULL, NULL),
(305, 306, 'F-Mobile_S550.jpg', 'F-Mobile S550', 1, 1, NULL, NULL),
(306, 307, 'F-mobile_S560.jpg', 'F-Mobile S560', 1, 1, NULL, NULL),
(307, 308, 'F-Mobile_B510.jpg', 'F-Mobile B510', 1, 1, NULL, NULL),
(308, 309, 'f-mobile_B530.jpg', 'F-Mobile B530', 1, 1, NULL, NULL),
(309, 310, 'F-Mobile-S600.jpg', 'F-Mobile S600', 1, 1, NULL, NULL),
(310, 311, 'F-Mobile_B600.jpg', 'F-Mobile B600', 1, 1, NULL, NULL),
(311, 312, 'F-Mobile_B800.jpg', 'F-Mobile B800', 1, 1, NULL, NULL),
(312, 313, 'F-mobile_B350.jpg', 'F-Mobile B350  ', 1, 1, NULL, NULL),
(313, 314, 'f-mobile_B590.jpg', 'F-Mobile B590', 1, 1, NULL, NULL),
(314, 315, 'F-Mobile_B250.jpg', 'F-Mobile B250', 1, 1, NULL, NULL),
(315, 316, 'F-mobile_B330.jpg', 'F-Mobile B330', 1, 1, NULL, NULL),
(316, 317, 'F-Mobile_B270.jpg', 'F-Mobile B270', 1, 1, NULL, NULL),
(317, 318, 'F-Mobile_B280.jpg', 'F-Mobile B280 ', 1, 1, NULL, NULL),
(318, 319, 'fmobile_B400.jpg', 'F-Mobile B400', 1, 1, NULL, NULL),
(319, 320, 'F-Mobile_B260.jpg', 'F-Mobile B260', 1, 1, NULL, NULL),
(320, 321, 'fmobile_b200.jpg', 'F-Mobile B200', 1, 1, NULL, NULL),
(321, 322, 'F-Mobile_B360.jpg', 'F-Mobile B360', 1, 1, NULL, NULL),
(322, 323, 'acer_ferrari.jpg', 'Acer LiQuid E Smart S100 Ferrari', 1, 1, NULL, NULL),
(323, 324, 'Acer-Stream.jpg', 'Acer Stream S110', 1, 1, NULL, NULL),
(324, 325, 'acer_S100.jpg', 'Acer LiQuid E Smart S100 ', 1, 1, NULL, NULL),
(325, 326, 'E400.jpg', 'Acer beTouch E400 ', 1, 1, NULL, NULL),
(326, 327, 'Acer-E130_v.jpg', 'Acer beTouch E130 ', 1, 1, NULL, NULL),
(327, 328, 'e120.jpg', 'Acer Smart E120', 1, 1, NULL, NULL),
(328, 329, 'Acer_beTouchE110.jpg', 'Acer beTouch E110', 1, 1, NULL, NULL),
(329, 330, '', 'Acer Liquid Metal', 1, 1, NULL, NULL),
(330, 331, 'X710.jpg', 'Philips X710  ', 1, 1, NULL, NULL),
(331, 332, 'X501.jpg', 'Philips X501', 1, 1, NULL, NULL),
(332, 333, 'Philips 9_9q.jpg', 'Philips 9@9q ', 1, 1, NULL, NULL),
(333, 334, 'Philips M600.jpg', 'Philips M600', 1, 1, NULL, NULL),
(334, 335, 'Philips-X100.jpg', 'Philips X100', 1, 1, NULL, NULL),
(335, 336, 'Philips_X600.jpg', 'Philips Xenium X600 ', 1, 1, NULL, NULL),
(336, 337, 'mobistar_M690s.jpg', 'Mobistar M690s', 1, 1, NULL, NULL),
(337, 338, 'Mobistar_89.jpg', 'Mobistar @89', 1, 1, NULL, NULL),
(338, 339, 'mobistar_F760.jpg', 'Mobistar F760', 1, 1, NULL, NULL),
(339, 340, 'mobistar_56.jpg', 'Mobistar @56  ', 1, 1, NULL, NULL),
(340, 341, 'Mobistar_90.jpg', 'Mobistar @90', 1, 1, NULL, NULL),
(341, 342, 'streak.jpg', 'Dell Streak ', 1, 1, NULL, NULL),
(342, 343, 'Dell_Aero.jpg', 'Dell Aero', 1, 1, NULL, NULL),
(343, 344, 'Dell_Flash.jpg', 'Dell Flash', 1, 1, NULL, NULL),
(344, 345, 'Dell_thunder.jpg', 'Dell Venue', 1, 1, NULL, NULL),
(345, 346, 'Dell_mini_3i.jpg', 'Dell Mini 3i', 1, 1, NULL, NULL),
(346, 347, 'dell_pro.jpg', 'Dell Venue Pro', 1, 1, NULL, NULL),
(347, 348, 'dell_XCD28.jpg', 'Dell XCD28 ', 1, 1, NULL, NULL),
(348, 349, 'Dell-XCD28.jpg', 'Dell XCD35', 1, 1, NULL, NULL),
(349, 350, 'Dell_Smoke.jpg', 'Dell Smoke', 1, 1, NULL, NULL),
(350, 351, 'Etouch_TD200.jpg', 'eTouch TD200', 1, 1, NULL, NULL),
(351, 352, 'Etouch_MK67.jpg', 'eTouch MK67', 1, 1, NULL, NULL),
(352, 353, 'E-Touch_MD82.jpg', 'eTouch MD82', 1, 1, NULL, NULL),
(353, 354, 'Acer-Aspire-4820T-185px-1.jpg', 'Acer Aspire 4820TG 452G50 (219)  ', 1, 1, NULL, NULL),
(354, 355, '2.png', 'Acer Aspire 4820TG 352G50Mn (038)  ', 1, 1, NULL, NULL),
(355, 356, 'Acer-Aspire-4820T-185px-1_1.jpg', 'Acer Aspire 4820T 452G50Mn (060)  ', 1, 1, NULL, NULL),
(356, 357, 'Ac.jpg', 'Acer Aspire 4820TG 372G32Mn (213)  ', 1, 1, NULL, NULL),
(357, 358, 'Acer-Aspire-4745G-185px.jpg', 'Acer Aspire 4745G 452G64Mn (066)  ', 1, 1, NULL, NULL),
(358, 359, 'Acer-Aspire-4745G-462G32Mn-057-185px-1.jpg', 'Acer Aspire 4745G 462G32Mn (057)  ', 1, 1, NULL, NULL),
(359, 360, 'Ac6.jpg', 'Acer Aspire 4820T 372G32Mn (232)  ', 1, 1, NULL, NULL),
(360, 361, 'acc5.jpg', 'Acer Aspire 4738G 452G50Mn (020)  ', 1, 1, NULL, NULL),
(361, 362, 'acc1.jpg', 'Acer Aspire 4738G 452G50Mn (017)  ', 1, 1, NULL, NULL),
(362, 363, 'Ac5.jpg', 'Acer Aspire 4738G 452G50Mn (045)  ', 1, 1, NULL, NULL),
(363, 364, 'a7.jpg', 'Acer Aspire 4820TG 452G50 (219) ', 1, 1, NULL, NULL),
(364, 365, 'Acer-Aspire-4820TG-352G50Mn-(038)-m.jpg.png', 'Acer Aspire 4820TG 352G50Mn (038)  ', 1, 1, NULL, NULL),
(365, 366, 'Acer-Aspire-4820T-185px-1_2.jpg', 'Acer Aspire 4820T 452G50Mn (060)', 1, 1, NULL, NULL),
(366, 367, 'Acer-Aspire-4820TG-372G32Mn-(213)-m.jpg.png', 'Acer Aspire 4820TG 372G32Mn (213)  ', 1, 1, NULL, NULL),
(367, 368, 'Acer-Aspire-4745G-452G64Mn-(066)-m.jpg.png', 'Acer Aspire 4745G 452G64Mn (066) ', 1, 1, NULL, NULL),
(368, 369, 'Acer-Aspire-4745G-462G32Mn-(057)-m.jpg.png', 'Acer Aspire 4745G 462G32Mn (057)  ', 1, 1, NULL, NULL),
(369, 370, 'Acer-Aspire-4820T-372G32Mn-(232)-m.jpg.png', 'Acer Aspire 4820T 372G32Mn (232)  ', 1, 1, NULL, NULL),
(370, 371, 'Acer-Aspire-4738G-452G50Mn-(020)-m.jpg.png', 'Acer Aspire 4738G 452G50Mn (020)  ', 1, 1, NULL, NULL),
(371, 372, 'Acer-Aspire-4738G-452G50Mn-(017)-m.jpg.png', 'Acer Aspire 4738G 452G50Mn (017)  ', 1, 1, NULL, NULL),
(372, 373, 'Acer-Aspire-4738G-452G50Mn-(045)-m.jpg.png', 'Acer Aspire 4738G 452G50Mn (045)  ', 1, 1, NULL, NULL),
(373, 374, 'Acer-Aspire-5745G-382G50Mn-(052)-m.jpg.png', 'Acer Aspire 5745G 382G50Mn (052)  ', 1, 1, NULL, NULL),
(374, 375, 'acer-aspire-4738-120px.jpg', 'Acer Aspire 4738 432G32Mn (035)  ', 1, 1, NULL, NULL),
(375, 376, 'Acer-Aspire-5742G-382G50Mn-(020)-m.jpg.png', 'Acer Aspire 5742G 382G50Mn (020)  ', 1, 1, NULL, NULL),
(376, 377, 'Acer-Aspire-5742G-382G50Mn-(040)-m.jpg.png', 'Acer Aspire 5742G 382G50Mn (040)  ', 1, 1, NULL, NULL),
(377, 378, 'Acer-Aspire-5742G-382G50Mn-(012)-m.jpg.png', 'Acer Aspire 5742G 382G50Mn (012)  ', 1, 1, NULL, NULL),
(378, 379, 'Acer-Aspire-4741---5452G32Mn-(071)-m.jpg.png', 'Acer Aspire 4741 - 5452G32Mn (071)  ', 1, 1, NULL, NULL),
(379, 380, 'Acer-Aspire-4745G-372G32Mn-(058)-m.jpg.png', 'Acer Aspire 4745G 372G32Mn (058)  ', 1, 1, NULL, NULL),
(380, 381, 'Acer-Aspire-4738G-372G50Mn-(032)-m.jpg.png', 'Acer Aspire 4738G 372G50Mn (032)  ', 1, 1, NULL, NULL),
(381, 382, 'Acer-Aspire-4738G-372G50Mn-(014)-m.jpg.png', 'Acer Aspire 4738G 372G50Mn (014)  ', 1, 1, NULL, NULL),
(382, 383, 'Acer-Aspire-5745G-372G32Mn-(041)-m.jpg.png', 'Acer Aspire 5745G 372G32Mn (041)  ', 1, 1, NULL, NULL),
(383, 384, 'Toshiba-Portege-R700-m.jpg.png', 'Toshiba Portege R700  ', 1, 1, NULL, NULL),
(384, 385, 'Toshiba-Portege-R700-m.jpg.png', 'Toshiba Portege R700 ', 1, 1, NULL, NULL),
(385, 386, 'Toshiba-Sattelite-L645-1059UBL-PSK0JL-00S001-m.jpg.png', 'Toshiba Sattelite L645 1059UBL PSK0JL 00S001', 1, 1, NULL, NULL),
(386, 387, 'Toshiba-Satellite-L640-1067U-PSK0JL-00F001-m.jpg.png', 'Toshiba Satellite L640 1067U PSK0JL 00F001  ', 1, 1, NULL, NULL),
(387, 388, 'poo-L.jpg', 'Toshiba Satellite L640 PSK0JL 001001 ', 1, 1, NULL, NULL),
(388, 389, '1L310-1-L.gif', 'Toshiba Satellite L310 T4200  ', 1, 1, NULL, NULL),
(389, 390, 'Toshiba-Satellite-C640-1008U-PSC02L-003001-m.jpg.png', 'Toshiba Satellite C640 1008U PSC02L 003001 ', 1, 1, NULL, NULL),
(390, 391, 'Toshiba-Satellite-M645-m.jpg.png', 'Toshiba Satellite M645 ', 1, 1, NULL, NULL),
(391, 392, 'Satellite-M300-N401_La.jpg', 'Toshiba Satellite M300 N401 (004001)  ', 1, 1, NULL, NULL),
(392, 393, 'Satellite-Pro-M200-E458_La.jpg', 'Toshiba Satellite Pro M200 E458 (01L002)  ', 1, 1, NULL, NULL),
(393, 394, 'Satellite-M200-E4311_La.jpg', 'Toshiba Satellite M200(E4311)  ', 1, 1, NULL, NULL),
(394, 395, 'Satellite-M300_La.jpg', 'Toshiba Satellite M300 A401(00C001)  ', 1, 1, NULL, NULL),
(395, 396, 'Satellite-M200-E436_La.jpg', 'Toshiba Satellite M200 E436 (046004)  ', 1, 1, NULL, NULL),
(396, 397, 'R500_La.jpg', 'Toshiba PORTEGE R500 E264 (07Y09J)  ', 1, 1, NULL, NULL),
(397, 398, 'Toshiba-M800-E330_La.jpg', 'Toshiba PORTEGE M800 E330 (02H00V)  ', 1, 1, NULL, NULL),
(398, 399, 'L300-A511-L.jpg', 'Toshiba Satellite L300 A511 (08502E)  ', 1, 1, NULL, NULL),
(399, 400, 'L300-5-L.jpg', 'Toshiba Satellite L300 S500 (00M00L)  ', 1, 1, NULL, NULL),
(400, 401, 'm300-L.jpg', 'Toshiba Satellite M300 P500 (00700L)  ', 1, 1, NULL, NULL),
(401, 402, 'M300-A406-L.jpg', 'Toshiba Satellite M300 A406 (001001)  ', 1, 1, NULL, NULL),
(402, 403, 'Toshiba-Qosmio-F60-m.jpg.png', 'Toshiba Qosmio F60  ', 1, 1, NULL, NULL),
(403, 404, '11B-M100-2011E.gif', 'Toshiba Satellite M100 (T0US00C)  ', 1, 1, NULL, NULL),
(404, 405, 'Toshiba-Satellite-Pro-S500L.jpg', 'Toshiba Satellite Pro S500  ', 1, 1, NULL, NULL),
(405, 406, '1TOL300-L.jpg', 'Toshiba Satellite L310 P401 (005001)  ', 1, 1, NULL, NULL),
(406, 407, 'L310-S402L.jpg', 'Toshiba Satellite L310 S402 (PSME6L 009001)  ', 1, 1, NULL, NULL),
(407, 408, 'Qosmio-F50-AV530L.jpg', 'Toshiba Qosmio F50 AV530 (02202N)  ', 1, 1, NULL, NULL),
(408, 409, 'Qosmio-X300L.jpg', 'Toshiba Qosmio X300 G770 (02202N)  ', 1, 1, NULL, NULL),
(409, 410, 'M300-P401L.jpg', 'Toshiba Satellite M300 P401 (009001)  ', 1, 1, NULL, NULL),
(410, 411, 'M300-P401L2.jpg', 'Toshiba Satellite M300 S403 (TosaM300 S403 DF 0090', 1, 1, NULL, NULL),
(411, 412, '1M800_La.jpg', 'Toshiba PORTEGE M800 A360 (033013)  ', 1, 1, NULL, NULL),
(412, 413, 'PORTEGE-M600-E360_La.jpg', 'Toshiba PORTEGE M600 E360 (02H009) ', 1, 1, NULL, NULL),
(413, 414, 'PORTEGE-M800-E336_La.jpg', 'Toshiba PORTEGE M800 E336 (02H00V)  ', 1, 1, NULL, NULL),
(414, 415, 'Asus-G51J-i7-720QM-m.jpg.png', 'Asus G51J i7-720QM  ', 1, 1, NULL, NULL),
(415, 416, 'Asus-N43JF-VX041-m.jpg.png', 'Asus N43JF VX041  ', 1, 1, NULL, NULL),
(416, 417, 'Asus-A42JA-VX058-m.jpg.png', 'Asus A42JA VX058 ', 1, 1, NULL, NULL),
(417, 418, 'Asus-U45JC-WX090-m.jpg.png', 'Asus U45JC WX090 ', 1, 1, NULL, NULL),
(418, 419, 'Asus-K42JE-VX043-m.jpg.png', 'Asus K42JE VX043  ', 1, 1, NULL, NULL),
(419, 420, 'Asus-X42JE-VX087-m.jpg.png', 'Asus X42JE VX087 ', 1, 1, NULL, NULL),
(420, 421, 'Asus-A42JE-VX019-m.jpg.png', 'Asus A42JE VX019  ', 1, 1, NULL, NULL),
(421, 422, 'Asus-A42JC-VX059-m.jpg.png', 'Asus A42JC VX059  ', 1, 1, NULL, NULL),
(422, 423, 'Asus-A42JE-VX003-m.jpg.png', 'Asus A42JE VX003  ', 1, 1, NULL, NULL),
(423, 424, 'Asus-K42JE-VX089-m.jpg.png', 'Asus K42JE VX089  ', 1, 1, NULL, NULL),
(424, 425, 'Asus-A42F-VX005-m.jpg.png', 'Asus A42F VX005  ', 1, 1, NULL, NULL),
(425, 426, 'Asus-A42JE-VX042-m.jpg.png', 'Asus A42JE VX042  ', 1, 1, NULL, NULL),
(426, 427, 'Asus-EeePC-1015PEM-m.jpg.png', 'Asus EeePC 1015PEM  ', 1, 1, NULL, NULL),
(427, 428, 'AsusZ99L__.jpg', 'Asus Z99L (AsZ99LDF 2330)  ', 1, 1, NULL, NULL),
(428, 429, '1ASUS-A8S_.jpg', 'Asus A8S (AS555004)  ', 1, 1, NULL, NULL),
(429, 430, 'Asus-Z99H-La.jpg', 'Asus Z99H T2250', 1, 1, NULL, NULL),
(430, 431, 'AsusZ99S__.jpg', 'Asus Z99S (AsZ99SDF 7300)  ', 1, 1, NULL, NULL),
(431, 432, 'Asus F9E.jpg', 'Asus F9E (AS730006)  ', 1, 1, NULL, NULL),
(432, 433, 'Asus-Z99E-La.jpg', 'Asus Z99E T5550', 1, 1, NULL, NULL),
(433, 434, 'AsusW7S__.jpg', 'Asus W7S (AS730005)  ', 1, 1, NULL, NULL),
(434, 435, 'Asus-AS8(T7300)-La.jpg', 'Asus A8S T7300  ', 1, 1, NULL, NULL),
(435, 436, 'AsusWF5e__.jpg', 'ASUS W5Fe (AS720001) ', 1, 1, NULL, NULL),
(436, 437, 'AsusS6FM__.jpg', 'Asus S6FM (AS720002)  ', 1, 1, NULL, NULL),
(437, 438, 'Asus-F9S-La.jpg', 'Asus F9S (AsF9SDF 7300)  ', 1, 1, NULL, NULL),
(438, 439, 'Asus-U3S-La.jpg', 'Asus U3S (AS730004)  ', 1, 1, NULL, NULL),
(439, 440, 'Asus-U6S-La.jpg', 'Asus U6S (AS725001)  ', 1, 1, NULL, NULL),
(440, 441, 'Asus-U1E-La.jpg', 'Asus U1E U7500  ', 1, 1, NULL, NULL),
(441, 442, 'Asus-VX2S-La.jpg', 'Asus VX2S (AS750003)  ', 1, 1, NULL, NULL),
(442, 443, '1Asus-X80L_La.jpg', 'Asus X80L T2330  ', 1, 1, NULL, NULL),
(443, 444, 'Asus-VX2S_La.jpg', 'Asus Lamborghini VX2S (T9300)', 1, 1, NULL, NULL),
(444, 445, 'Samsung-Q428-i5-460M-m.jpg.png', 'Samsung Q428 i5 460M  ', 1, 1, NULL, NULL),
(445, 446, 'Samsung-Q428-DS04VN-i3-370M-m.jpg.png', 'Samsung Q428 DS04VN i3 370M  ', 1, 1, NULL, NULL),
(446, 447, 'Samsung-Q428-i3-350M-m.jpg.png', 'Samsung Q428 i3 350M  ', 1, 1, NULL, NULL),
(447, 448, 'Samsung-R439-DT08VN-m.jpg.png', 'Samsung R439 DT08VN ', 1, 1, NULL, NULL),
(448, 449, 'Samsung-R439-DA04VN-m.jpg.png', 'Samsung R439 DA04VN ', 1, 1, NULL, NULL),
(449, 450, '1Sam2-L.jpg', 'Samsung R439  ', 1, 1, NULL, NULL),
(450, 451, 'Samsung-RV408-A01VN-m.jpg.png', 'Samsung RV408 A01VN  ', 1, 1, NULL, NULL),
(451, 452, 'Samsung-N148-DP04VN-m.jpg.png', 'Samsung N148 DP04VN  ', 1, 1, NULL, NULL),
(452, 453, 'Samsung-N148-DP05VN-m.jpg.png', 'Samsung N148 DP05VN  ', 1, 1, NULL, NULL),
(453, 454, 'Samsung-N143-DP01VN-m.jpg.png', 'Samsung N143 DP01VN  ', 1, 1, NULL, NULL),
(454, 455, 'Samsung-SF510-m.jpg.png', 'Samsung SF510-S02DE  ', 1, 1, NULL, NULL),
(455, 456, 'Samsung-SF510-m2.jpg.png', 'Samsung R470  ', 1, 1, NULL, NULL),
(456, 457, 'Samsung-R428-(DA02VN)-m.jpg.png', 'Samsung R428 (DA02VN)  ', 1, 1, NULL, NULL),
(457, 458, 'Samsung-NB30-L.jpg', 'Samsung NB30', 1, 1, NULL, NULL),
(458, 459, 'N310-13GBKL.jpg', 'Samsung N310 13GBK  ', 1, 1, NULL, NULL),
(459, 460, 'N310-13GMBL.jpg', 'Samsung N310 13GMB', 1, 1, NULL, NULL),
(460, 461, 'N310-13GBL.jpg', 'Samsung N310 13GB ', 1, 1, NULL, NULL),
(461, 462, 'N120-12GWL.jpg', 'Samsung N120 12GW ', 1, 1, NULL, NULL),
(462, 463, 'N120-12GBKL.jpg', 'Samsung N120 12GBK  ', 1, 1, NULL, NULL),
(463, 464, 'N120-13GBLL.jpg', 'Samsung N120 13GBL ', 1, 1, NULL, NULL),
(464, 465, 'N130-13PL.jpg', 'Samsung N130 13P  ', 1, 1, NULL, NULL),
(465, 466, 'N130-13BL.jpg', 'Samsung N130 13B  ', 1, 1, NULL, NULL),
(466, 467, 'SamsungR720L.jpg', 'SAMSUNG R720  ', 1, 1, NULL, NULL),
(467, 468, 'Samsung-NF210-m.jpg.png', 'Samsung NF210  ', 1, 1, NULL, NULL),
(468, 469, 'tgdd_samsung-p530.jpg', 'Samsung P430  ', 1, 1, NULL, NULL),
(469, 470, 'Samsung-P430-Review-06-300x203.jpg', 'Samsung P530 Pro  ', 1, 1, NULL, NULL),
(470, 471, 'Samsung-p580-notebook.jpg', 'Samsung P480 Pro ', 1, 1, NULL, NULL),
(471, 472, 'Samsung-RF510-m.jpg.png', 'Samsung RF510  ', 1, 1, NULL, NULL),
(472, 473, 'http://localhost:8000/storage/photos/100/upload/products/FB_IMG_1612835960932.jpg', 'Samsung RF710', 1, 1, NULL, '2021-06-30'),
(473, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(474, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(475, 507, '1617522669.jpg', NULL, NULL, NULL, NULL, NULL),
(476, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(477, 509, '1617524569.jpg', 'tai-nghe-bluetooth-true-wireless-jabra-elite-75t-17-600x600.jpg', NULL, NULL, NULL, NULL),
(483, 527, NULL, NULL, 1, 1, '2021-06-30', '2021-06-30'),
(484, 528, 'http://localhost:8000/storage/photos/100/upload/products/FB_IMG_1612835960932.jpg', 'Moc moc', 1, 1, '2021-07-01', '2021-07-01');
...
DROP TABLE IF EXISTS `fs_question`;
...
--
-- Đang đổ dữ liệu cho bảng `fs_question`
--
...
--
-- Đang đổ dữ liệu cho bảng `fs_roles`
--
...
--
-- Cấu trúc bảng cho bảng `fs_user`
--
...
--
-- Đang đổ dữ liệu cho bảng `fs_user`
--

INSERT INTO `fs_user` (`id`, `password`, `email`, `name`, `mobile`, `address`, `dob`, `gender`, `created_at`, `updated_at`, `up`, `group_id`, `active`, `code`) VALUES
(100, '$2y$10$H1E8HaSfruZXF.vZkG2EKu39Pg0Sf3mmNWpRu1M7NGdnifvVuAHWW', 'admin@gmail.com', 'Lê Văn Test', '0901234567', '49 Hoàng Văn Thụ, Phường 2, Quận Phú Nhuận, TP. Hồ Chí Minh', '1994-05-11', 1, '0000-00-00 00:00:00', '2021-07-01 01:37:19', '0000-00-00 00:00:00', 0, 1, ''),
(142, '$2y$10$ularmq.akpC3fefoip572.1M0keeKEumRuedZl2.D1aKl7lPhHSMS', 'aaa@gmail.com', 'Alex', '0352902397', '388 Nguyen Thi Lang', NULL, NULL, '2021-06-26 20:19:01', '2021-06-26 20:19:01', NULL, NULL, 1, NULL),
(143, '$2y$10$SJ37GiwPQCN8cmYP4NBalOiAiXAzE.AHYtU2kTjZKECU6tkOjXhr.', 'zzz@gmail.com', 'Alex Chao', NULL, NULL, NULL, NULL, '2021-06-26 20:31:50', '2021-06-26 20:31:50', NULL, NULL, 1, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `fs_visit`
--

DROP TABLE IF EXISTS `fs_visit`;
CREATE TABLE IF NOT EXISTS `fs_visit` (
  `id` int(11) NOT NULL,
  `cnt` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Đang đổ dữ liệu cho bảng `fs_visit`
--
...
(6, '2021_03_30_125727_create_sessions_table', 1);
...
('sfqg8koIruHzw3aFnz4zjbVQMI5DDiaJYgEZgkai', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoic1haaEZ0bzVJRlZoVFJmMVFoMlp2REg5cnhFdkZxSHo1RDNBTWU3YSI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly9sb2NhbGhvc3Q6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1617169352),
('qzbvHIfQMdFH1pvJU2gFVCsqpYJgvIYefjrHLe2j', 114, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36', '', 1617168848);
...
(1, 'Khánh Nguyễn Duy', 'admin@gmail.com', NULL, '$2y$10$dlfADImqtERY33FjznM6Uu/IZk7z40g3T6tQ6QnsJT.AI.GldLGLO', NULL, NULL, NULL, NULL, NULL, '2021-03-30 06:37:26', '2021-03-30 06:37:26');
COMMIT;
